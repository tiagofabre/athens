...
var G__50824 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__50824__$1 = (((G__50824 == null))?null:cljs.core.iterate((function (loc){
...
var G__50824__$2 = (((G__50824__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__50824__$1));
var G__50824__$3 = (((G__50824__$2 == null))?null:cljs.core.last(G__50824__$2));
if((G__50824__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__50824__$3);
}
} else {
return zloc;
}
...
var G__50867 = rewrite_clj.zip.move.right(v);
var G__50868 = rewrite_clj.zip.move.up(v);
loc = G__50867;
parent = G__50868;
continue;
} else {
var G__50870 = rewrite_clj.zip.move.right(v0);
var G__50871 = parent;
loc = G__50870;
parent = G__50871;
continue;
...
var G__50874 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__50875 = rewrite_clj.zip.move.up(v);
loc = G__50874;
parent = G__50875;
continue;
} else {
var G__50876 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__50877 = parent;
loc = G__50876;
parent = G__50877;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__50844 = zloc;
var G__50844__$1 = (((G__50844 == null))?null:rewrite_clj.zip.move.down(G__50844));
var G__50844__$2 = (((G__50844__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__50844__$1,k));
if((G__50844__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__50844__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__50845 = rewrite_clj.zip.move.down(zloc);
var G__50845__$1 = (((G__50845 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__50845));
if((G__50845__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__50845__$1);
}
})(),k);
}
});
