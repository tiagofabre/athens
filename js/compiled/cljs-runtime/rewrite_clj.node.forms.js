...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k49680,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k49680,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__49704){
var vec__49706 = p__49704;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49706,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49706,(1),null);
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__49679){
var self__ = this;
var G__49679__$1 = this;
return (new cljs.core.RecordIter((0),G__49679__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this49681,other49682){
var self__ = this;
var this49681__$1 = this;
return (((!((other49682 == null)))) && ((this49681__$1.constructor === other49682.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49681__$1.children,other49682.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49681__$1.__extmap,other49682.__extmap)));
}));
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__49679){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__49736 = cljs.core.keyword_identical_QMARK_;
var expr__49737 = k__4388__auto__;
if(cljs.core.truth_((pred__49736.cljs$core$IFn$_invoke$arity$2 ? pred__49736.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__49737) : pred__49736.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__49737)))){
return (new rewrite_clj.node.forms.FormsNode(G__49679,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.forms.FormsNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__49679),null));
}
}));
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__49679){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.forms.FormsNode(self__.children,G__49679,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.forms.map__GT_FormsNode = (function rewrite_clj$node$forms$map__GT_FormsNode(G__49683){
var extmap__4419__auto__ = (function (){var G__49753 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__49683,new cljs.core.Keyword(null,"children","children",-940561982));
...
return (new rewrite_clj.node.forms.FormsNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__49683),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
