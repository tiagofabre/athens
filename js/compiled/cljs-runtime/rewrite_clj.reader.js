...
var len__4736__auto___50354 = arguments.length;
var i__4737__auto___50355 = (0);
while(true){
if((i__4737__auto___50355 < len__4736__auto___50354)){
args__4742__auto__.push((arguments[i__4737__auto___50355]));

var G__50356 = (i__4737__auto___50355 + (1));
i__4737__auto___50355 = G__50356;
continue;
} else {
}
break;
...
/** @this {Function} */
(rewrite_clj.reader.throw_reader.cljs$lang$applyTo = (function (seq50302){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50303,G__50304,seq50302__$2);
}));
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(rewrite_clj.reader.read_until(reader,(function (p1__50318_SHARP_){
return (((p1__50318_SHARP_ == null)) || (rewrite_clj.reader.linebreak_QMARK_(p1__50318_SHARP_)));
...
var G__50384 = (cljs.core.truth_((p_QMARK_.cljs$core$IFn$_invoke$arity$1 ? p_QMARK_.cljs$core$IFn$_invoke$arity$1(v) : p_QMARK_.call(null,v)))?(c + (1)):c);
var G__50385 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(vs,v);
c = G__50384;
vs = G__50385;
continue;
} else {
