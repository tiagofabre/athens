...
if((i < len)){
var k = (ks[i]);
var G__47229 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__47230 = (i + (1));
m = G__47229;
i = G__47230;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__47043 = c;
var G__47043__$1 = (((G__47043 == null))?null:G__47043.prototype);
if((G__47043__$1 == null)){
return null;
} else {
return G__47043__$1.reagentRender;
}
})() == null)))));
});
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__47071 = c;
var G__47071__$1 = (((G__47071 == null))?null:G__47071.prototype);
if((G__47071__$1 == null)){
return null;
} else {
return G__47071__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__47249__delegate = function (args){
var G__47111 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__47111) : day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component.as_element.call(null,G__47111));
};
var G__47249 = function (var_args){
var args = null;
...
while (G__47251__i < G__47251__a.length) {G__47251__a[G__47251__i] = arguments[G__47251__i + 0]; ++G__47251__i;}
  args = new cljs.core.IndexedSeq(G__47251__a,0,null);
} 
return G__47249__delegate.call(this,args);};
G__47249.cljs$lang$maxFixedArity = 0;
G__47249.cljs$lang$applyTo = (function (arglist__47252){
var args = cljs.core.seq(arglist__47252);
return G__47249__delegate(args);
});
G__47249.cljs$core$IFn$_invoke$arity$variadic = G__47249__delegate;
return G__47249;
})()
;})(c,f,_,res))
:res);
...
var _STAR_current_component_STAR__orig_val__47114 = day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__47115 = c;
(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__47115);
...
}finally {(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__47114);
}});
...
var G__47128 = key;
var G__47128__$1 = (((G__47128 instanceof cljs.core.Keyword))?G__47128.fqn:null);
switch (G__47128__$1) {
...
var c = this;
var G__47169_47280 = goog.object.get(c,"cljsRatom");
if((G__47169_47280 == null)){
} else {
day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.dispose_BANG_(G__47169_47280);
}
...
var renders_47284 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_47285 = cljs.core.first(cljs.core.vals(renders_47284));
...
if((cljs.core.count(renders_47284) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_47284))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_47285)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_47285], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__47193 = o;
goog.object.set(G__47193,cljs.core.name(k),v);
...
var name = (function (){var G__47198 = fiber;
var G__47198__$1 = (((G__47198 == null))?null:G__47198.type);
if((G__47198__$1 == null)){
return null;
} else {
return G__47198__$1.displayName;
}
})();
var parent = (function (){var G__47199 = fiber;
if((G__47199 == null)){
return null;
} else {
return G__47199.return;
}
})();
var path = (function (){var G__47200 = parent;
var G__47200__$1 = (((G__47200 == null))?null:(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__47200) : day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component.fiber_component_path.call(null,G__47200)));
if((G__47200__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__47200__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4126__auto__ = (function (){var G__47202 = c;
if((G__47202 == null)){
return null;
} else {
return goog.object.get(G__47202,"_reactInternalFiber");
}
})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
return G__47203._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4126__auto__ = (function (){var G__47205 = c;
if((G__47205 == null)){
return null;
} else {
return goog.object.get(G__47205,"_reactInternalInstance");
}
})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
var or__4126__auto____$1 = (function (){var G__47207 = c;
if((G__47207 == null)){
return null;
} else {
return G__47207._reactInternalInstance;
}
})();
if(cljs.core.truth_(or__4126__auto____$1)){
return or__4126__auto____$1;
...
var elem = (function (){var or__4126__auto__ = (function (){var G__47209 = instance;
if((G__47209 == null)){
return null;
} else {
return goog.object.get(G__47209,"_currentElement");
}
})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
var G__47210 = instance;
if((G__47210 == null)){
return null;
} else {
return G__47210._currentElement;
}
}
})();
var name = (function (){var G__47211 = elem;
var G__47211__$1 = (((G__47211 == null))?null:G__47211.type);
if((G__47211__$1 == null)){
return null;
} else {
return G__47211__$1.displayName;
}
})();
var owner = (function (){var or__4126__auto__ = (function (){var G__47213 = elem;
if((G__47213 == null)){
return null;
} else {
return goog.object.get(G__47213,"_owner");
}
})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
return G__47214._owner;
}
}
})();
var path = (function (){var G__47215 = owner;
var G__47215__$1 = (((G__47215 == null))?null:(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__47215) : day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component.component_path.call(null,G__47215)));
if((G__47215__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__47215__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__47216 = c;
var G__47216__$1 = (((G__47216 == null))?null:G__47216.constructor);
if((G__47216__$1 == null)){
return null;
} else {
return day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.util.fun_name(G__47216__$1);
}
}
})();
