...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k49777,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k49777,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__49790){
var vec__49792 = p__49790;
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__49776){
var self__ = this;
var G__49776__$1 = this;
return (new cljs.core.RecordIter((0),G__49776__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this49778,other49779){
var self__ = this;
var this49778__$1 = this;
return (((!((other49779 == null)))) && ((this49778__$1.constructor === other49779.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49778__$1.tag,other49779.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49778__$1.prefix,other49779.prefix)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49778__$1.sym,other49779.sym)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49778__$1.children,other49779.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49778__$1.__extmap,other49779.__extmap)));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__49776){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__49811 = cljs.core.keyword_identical_QMARK_;
var expr__49812 = k__4388__auto__;
if(cljs.core.truth_((pred__49811.cljs$core$IFn$_invoke$arity$2 ? pred__49811.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__49812) : pred__49811.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__49812)))){
return (new rewrite_clj.node.quote.QuoteNode(G__49776,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__49811.cljs$core$IFn$_invoke$arity$2 ? pred__49811.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__49812) : pred__49811.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__49812)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__49776,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__49811.cljs$core$IFn$_invoke$arity$2 ? pred__49811.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__49812) : pred__49811.call(null,new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__49812)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__49776,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__49811.cljs$core$IFn$_invoke$arity$2 ? pred__49811.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__49812) : pred__49811.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__49812)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__49776,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__49776),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__49776){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__49776,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__49781){
var extmap__4419__auto__ = (function (){var G__49830 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__49781,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
...
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__49781),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__49781),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__49781),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__49781),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var G__49872 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__49872;
continue;
}
break;
...
var G__49876 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__49876;
continue;
}
break;
...
var G__49877 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__49877;
continue;
}
break;
...
var G__49879 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__49879;
continue;
}
break;
