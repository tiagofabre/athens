...
var hierarchy__4623__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__89172 = cljs.core.get_global_hierarchy;
return (fexpr__89172.cljs$core$IFn$_invoke$arity$0 ? fexpr__89172.cljs$core$IFn$_invoke$arity$0() : fexpr__89172.call(null));
})());
...
return cljs.core.some((function (p__89175){
var vec__89177 = p__89175;
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__89177,(0),null);
var render = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__89177,(1),null);
...
var G__89227__delegate = function (contents){
...
var G__89227 = function (var_args){
var contents = null;
if (arguments.length > 0) {
var G__89228__i = 0, G__89228__a = new Array(arguments.length -  0);
while (G__89228__i < G__89228__a.length) {G__89228__a[G__89228__i] = arguments[G__89228__i + 0]; ++G__89228__i;}
  contents = new cljs.core.IndexedSeq(G__89228__a,0,null);
} 
return G__89227__delegate.call(this,contents);};
G__89227.cljs$lang$maxFixedArity = 0;
G__89227.cljs$lang$applyTo = (function (arglist__89229){
var contents = cljs.core.seq(arglist__89229);
return G__89227__delegate(contents);
});
G__89227.cljs$core$IFn$_invoke$arity$variadic = G__89227__delegate;
return G__89227;
})()
,(function (text){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89192__$1,new cljs.core.Keyword(null,"url","url",276297046));
var alt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89192__$1,new cljs.core.Keyword(null,"alt","alt",-3214426));
...
var G__89242__delegate = function (contents){
return athens.parse_renderer.component.cljs$core$IFn$_invoke$arity$2(cljs.core.first(contents),uid);
};
var G__89242 = function (var_args){
var contents = null;
if (arguments.length > 0) {
var G__89243__i = 0, G__89243__a = new Array(arguments.length -  0);
while (G__89243__i < G__89243__a.length) {G__89243__a[G__89243__i] = arguments[G__89243__i + 0]; ++G__89243__i;}
  contents = new cljs.core.IndexedSeq(G__89243__a,0,null);
} 
return G__89242__delegate.call(this,contents);};
G__89242.cljs$lang$maxFixedArity = 0;
G__89242.cljs$lang$applyTo = (function (arglist__89244){
var contents = cljs.core.seq(arglist__89244);
return G__89242__delegate(contents);
});
G__89242.cljs$core$IFn$_invoke$arity$variadic = G__89242__delegate;
return G__89242;
})()
,(function (text){
...
var G__89245__delegate = function (title_coll){
return athens.parse_renderer.render_page_link(title_coll);
};
var G__89245 = function (var_args){
var title_coll = null;
if (arguments.length > 0) {
var G__89247__i = 0, G__89247__a = new Array(arguments.length -  0);
while (G__89247__i < G__89247__a.length) {G__89247__a[G__89247__i] = arguments[G__89247__i + 0]; ++G__89247__i;}
  title_coll = new cljs.core.IndexedSeq(G__89247__a,0,null);
} 
return G__89245__delegate.call(this,title_coll);};
G__89245.cljs$lang$maxFixedArity = 0;
G__89245.cljs$lang$applyTo = (function (arglist__89248){
var title_coll = cljs.core.seq(arglist__89248);
return G__89245__delegate(title_coll);
});
G__89245.cljs$core$IFn$_invoke$arity$variadic = G__89245__delegate;
return G__89245;
})()
,(function (text){
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.parse_renderer.block_ref,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"block-ref"], null)),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),"contents",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (p1__89186_SHARP_){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$2(ref_uid,p1__89186_SHARP_);
...
var G__89260__delegate = function (title_coll){
var node = athens.parse_renderer.pull_node_from_string(title_coll);
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.parse_renderer.hashtag,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),"hashtag",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (p1__89185_SHARP_){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("block","uid","block/uid",-1623585167).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(node)),p1__89185_SHARP_);
...
var G__89260 = function (var_args){
var title_coll = null;
if (arguments.length > 0) {
var G__89270__i = 0, G__89270__a = new Array(arguments.length -  0);
while (G__89270__i < G__89270__a.length) {G__89270__a[G__89270__i] = arguments[G__89270__i + 0]; ++G__89270__i;}
  title_coll = new cljs.core.IndexedSeq(G__89270__a,0,null);
} 
return G__89260__delegate.call(this,title_coll);};
G__89260.cljs$lang$maxFixedArity = 0;
G__89260.cljs$lang$applyTo = (function (arglist__89272){
var title_coll = cljs.core.seq(arglist__89272);
return G__89260__delegate(title_coll);
});
G__89260.cljs$core$IFn$_invoke$arity$variadic = G__89260__delegate;
return G__89260;
})()
,(function (p__89197,text){
var map__89198 = p__89197;
var map__89198__$1 = (((((!((map__89198 == null))))?(((((map__89198.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__89198.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__89198):map__89198);
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89198__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
var G__89188 = tree;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__89187,G__89188) : instaparse.core.transform.call(null,G__89187,G__89188));
});
/**
