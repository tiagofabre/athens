...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_45036 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_45036(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_45040 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_45040(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_45045 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_45045(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_45053 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_45053(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_45058 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_45058(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_45059 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_45059(reader);
}
});
...
var G__45115 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__45116 = s.append(c);
c = G__45115;
s = G__45116;
continue;
}
