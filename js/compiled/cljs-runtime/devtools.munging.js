...
var o42213 = temp__5733__auto__;
var temp__5733__auto____$1 = (o42213["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o42214 = temp__5733__auto____$1;
return (o42214["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__41633__auto__ = f;
return (o__41633__auto__["toString"]).call(o__41633__auto__);
} else {
return "";
}
}catch (e42222){var _ = e42222;
return "";
}});
...
try{var o__41633__auto___42590 = t;
(o__41633__auto___42590["cljs$lang$ctorPrWriter"]).call(o__41633__auto___42590,t,writer);
}catch (e42235){var __42591 = e42235;
}
...
var char_code = (function (){var o__41633__auto__ = (new String(char$));
return (o__41633__auto__["charCodeAt"]).call(o__41633__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__41633__auto__ = String;
return (o__41633__auto__["fromCharCode"]).call(o__41633__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__42290 = num_code;
switch (G__42290) {
case (1):
return (185);
...
var o__41633__auto__ = String;
return (o__41633__auto__["fromCharCode"]).call(o__41633__auto__,superscript_code);
});
/**
...
}catch (e42314){var _e__41682__auto__ = e42314;
return false;
}})())){
...
var vec__42317 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42317,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o42341 = temp__5733__auto__;
var temp__5733__auto____$1 = (o42341["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o42342 = temp__5733__auto____$1;
return (o42342["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4736__auto___42616 = arguments.length;
var i__4737__auto___42617 = (0);
while(true){
if((i__4737__auto___42617 < len__4736__auto___42616)){
args__4742__auto__.push((arguments[i__4737__auto___42617]));

var G__42618 = (i__4737__auto___42617 + (1));
i__4737__auto___42617 = G__42618;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__42356){
var vec__42359 = p__42356;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42359,(0),null);
...
var G__42623 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__42624 = cljs.core.butlast(remaining_tokens);
name_tokens = G__42623;
remaining_tokens = G__42624;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq42350){
var G__42351 = cljs.core.first(seq42350);
var seq42350__$1 = cljs.core.next(seq42350);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42351,seq42350__$1);
}));
...
var vec__42378 = cljs.core.split_with((function (p1__42376_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__42376_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42378,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42378,(1),null);
...
var vec__42391 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42391,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42391,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__42630 = cljs.core.rest(remaining_tokens);
var G__42631 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__42630;
name_tokens = G__42631;
continue;
} else {
...
var vec__42407 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42407,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42407,(1),null);
var vec__42410 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42410,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42410,(1),null);
var vec__42413 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42413,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42413,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42413,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42413,(3),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__42437 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42437,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42437,(1),null);
var vec__42440 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42440,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42440,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__42450 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__42450) : devtools.munging.parse_fn_info_deep.call(null,G__42450));
})()));
}
} else {
return fn_info;
...
var G__42658 = (arity + (1));
var G__42659 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__42475){
var vec__42476 = p__42475;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42476,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42476,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42484_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__42484_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42485_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__42485_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___42664 = arguments.length;
var i__4737__auto___42665 = (0);
while(true){
if((i__4737__auto___42665 < len__4736__auto___42664)){
args__4742__auto__.push((arguments[i__4737__auto___42665]));

var G__42669 = (i__4737__auto___42665 + (1));
i__4737__auto___42665 = G__42669;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__42496){
var vec__42497 = p__42496;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42497,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq42494){
var G__42495 = cljs.core.first(seq42494);
var seq42494__$1 = cljs.core.next(seq42494);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42495,seq42494__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42525__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42525__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42525__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42525__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__42526 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42526,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42526,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42526,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42526,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42526,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42526,(5),null);
...
var o__41633__auto__ = f;
return (o__41633__auto__["getBasis"]).call(o__41633__auto__);
});
/**
...
}catch (e42541){var _e__41682__auto__ = e42541;
...
var G__42684 = (obj[cljs.core.first(path)]);
var G__42685 = cljs.core.rest(path);
obj = G__42684;
path = G__42685;
continue;
} else {
...
var _STAR_ = (function (accum,p__42561){
var vec__42562 = p__42561;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42562,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42562,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__42567){
var vec__42569 = p__42567;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42569,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42569,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42569,(2),null);
...
var post_process = (function (p__42582){
var vec__42583 = p__42582;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42583,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42583,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42579_SHARP_){
return (obj[cljs.core.first(p1__42579_SHARP_)]);
}),sorted_matches);
