...
var G__50743 = (function (){var G__50744 = (rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1(node) : rewrite_clj.node.sexpr.call(null,node));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__50744) : f.call(null,G__50744));
})();
return (rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1(G__50743) : rewrite_clj.node.coerce.call(null,G__50743));
});
/**
...
var len__4736__auto___50786 = arguments.length;
var i__4737__auto___50787 = (0);
while(true){
if((i__4737__auto___50787 < len__4736__auto___50786)){
args__4742__auto__.push((arguments[i__4737__auto___50787]));

var G__50788 = (i__4737__auto___50787 + (1));
i__4737__auto___50787 = G__50788;
continue;
} else {
}
break;
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.edit_node,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__50748_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__50748_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq50753){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50754,G__50755,seq50753__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__50772 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__50772) : str_fn.call(null,G__50772));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__50774 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__50774) : str_fn.call(null,G__50774));
})()):null)));
...
var G__50778 = rewrite_clj.zip.base.tag(zloc);
var G__50778__$1 = (((G__50778 instanceof cljs.core.Keyword))?G__50778.fqn:null);
switch (G__50778__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__50776_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50776_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__50777_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50777_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50778__$1)].join('')));

}
});
rewrite_clj.zip.editz.suffix = (function rewrite_clj$zip$editz$suffix(zloc,s){
var G__50782 = rewrite_clj.zip.base.tag(zloc);
var G__50782__$1 = (((G__50782 instanceof cljs.core.Keyword))?G__50782.fqn:null);
switch (G__50782__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__50781_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50781_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50782__$1)].join('')));
