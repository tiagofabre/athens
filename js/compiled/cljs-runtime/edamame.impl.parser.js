...
var cond_splice_QMARK_ = (function (){var G__91143 = next_val;
var G__91143__$1 = (((G__91143 == null))?null:cljs.core.meta(G__91143));
if((G__91143__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("edamame.impl.parser","cond-splice","edamame.impl.parser/cond-splice",1534599765).cljs$core$IFn$_invoke$arity$1(G__91143__$1);
}
})();
...
var seq__91144_91394 = cljs.core.seq(next_val);
var chunk__91145_91395 = null;
var count__91146_91396 = (0);
var i__91147_91397 = (0);
while(true){
if((i__91147_91397 < count__91146_91396)){
var v_91398 = chunk__91145_91395.cljs$core$IIndexed$_nth$arity$2(null,i__91147_91397);
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(vals,v_91398);


var G__91399 = seq__91144_91394;
var G__91400 = chunk__91145_91395;
var G__91401 = count__91146_91396;
var G__91402 = (i__91147_91397 + (1));
seq__91144_91394 = G__91399;
chunk__91145_91395 = G__91400;
count__91146_91396 = G__91401;
i__91147_91397 = G__91402;
continue;
} else {
var temp__5735__auto___91403 = cljs.core.seq(seq__91144_91394);
if(temp__5735__auto___91403){
var seq__91144_91404__$1 = temp__5735__auto___91403;
if(cljs.core.chunked_seq_QMARK_(seq__91144_91404__$1)){
var c__4556__auto___91405 = cljs.core.chunk_first(seq__91144_91404__$1);
var G__91406 = cljs.core.chunk_rest(seq__91144_91404__$1);
var G__91407 = c__4556__auto___91405;
var G__91408 = cljs.core.count(c__4556__auto___91405);
var G__91409 = (0);
seq__91144_91394 = G__91406;
chunk__91145_91395 = G__91407;
count__91146_91396 = G__91408;
i__91147_91397 = G__91409;
continue;
} else {
var v_91410 = cljs.core.first(seq__91144_91404__$1);
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(vals,v_91410);


var G__91411 = cljs.core.next(seq__91144_91404__$1);
var G__91412 = null;
var G__91413 = (0);
var G__91414 = (0);
seq__91144_91394 = G__91411;
chunk__91145_91395 = G__91412;
count__91146_91396 = G__91413;
i__91147_91397 = G__91414;
continue;
}
} else {
}
...
var G__91418 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(vals,next_val);
vals = G__91418;
continue;
...
if(("\\" === ch)){
var ch_91419__$1 = reader.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
if((ch_91419__$1 == null)){
edamame.impl.parser.throw_reader.cljs$core$IFn$_invoke$arity$2(reader,"Error while parsing regex");
} else {
}

sb.append(ch_91419__$1);
} else {
}

var G__91420 = reader.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__91420;
continue;
}
}
...
var iter__4529__auto__ = (function edamame$impl$parser$duplicate_keys_error_$_duplicates_$_iter__91164(s__91165){
return (new cljs.core.LazySeq(null,(function (){
var s__91165__$1 = s__91165;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__91165__$1);
if(temp__5735__auto__){
var s__91165__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__91165__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__91165__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__91167 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__91166 = (0);
while(true){
if((i__91166 < size__4528__auto__)){
var vec__91168 = cljs.core._nth(c__4527__auto__,i__91166);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91168,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91168,(1),null);
if((freq > (1))){
cljs.core.chunk_append(b__91167,id);

var G__91422 = (i__91166 + (1));
i__91166 = G__91422;
continue;
} else {
var G__91423 = (i__91166 + (1));
i__91166 = G__91423;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__91167),edamame$impl$parser$duplicate_keys_error_$_duplicates_$_iter__91164(cljs.core.chunk_rest(s__91165__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__91167),null);
}
} else {
var vec__91171 = cljs.core.first(s__91165__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91171,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91171,(1),null);
if((freq > (1))){
return cljs.core.cons(id,edamame$impl$parser$duplicate_keys_error_$_duplicates_$_iter__91164(cljs.core.rest(s__91165__$2)));
} else {
var G__91424 = cljs.core.rest(s__91165__$2);
s__91165__$1 = G__91424;
continue;
}
}
} else {
...
if(match_QMARK_){
var G__91425 = (edamame.impl.parser.parse_next.cljs$core$IFn$_invoke$arity$2 ? edamame.impl.parser.parse_next.cljs$core$IFn$_invoke$arity$2(ctx,reader) : edamame.impl.parser.parse_next.call(null,ctx,reader));
match = G__91425;
continue;
} else {
var G__91176_91426 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ctx,new cljs.core.Keyword("edamame.impl.parser","suppress","edamame.impl.parser/suppress",1718484755),true);
var G__91177_91427 = reader;
(edamame.impl.parser.parse_next.cljs$core$IFn$_invoke$arity$2 ? edamame.impl.parser.parse_next.cljs$core$IFn$_invoke$arity$2(G__91176_91426,G__91177_91427) : edamame.impl.parser.parse_next.call(null,G__91176_91426,G__91177_91427));
...
var G__91179 = cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4((edamame.impl.parser.parse_next.cljs$core$IFn$_invoke$arity$2 ? edamame.impl.parser.parse_next.cljs$core$IFn$_invoke$arity$2(ctx,reader) : edamame.impl.parser.parse_next.call(null,ctx,reader)),cljs.core.assoc,new cljs.core.Keyword("edamame","read-cond-splicing","edamame/read-cond-splicing",-1992728777),splice_QMARK_);
return (opt.cljs$core$IFn$_invoke$arity$1 ? opt.cljs$core$IFn$_invoke$arity$1(G__91179) : opt.call(null,G__91179));
} else {
reader.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
...
if(splice_QMARK_){
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(match,(function (p1__91178_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__91178_SHARP_,new cljs.core.Keyword("edamame.impl.parser","cond-splice","edamame.impl.parser/cond-splice",1534599765),true);
}));
} else {
return match;
...
var G__91195 = c;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__91195)){
return edamame.impl.parser.throw_reader.cljs$core$IFn$_invoke$arity$2(reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("\"",G__91195)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("_",G__91195)){
reader.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
...
var ks_91437 = cljs.core.take_nth.cljs$core$IFn$_invoke$arity$2((2),elements);
if(cljs.core.truth_(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.distinct_QMARK_,ks_91437))){
} else {
edamame.impl.parser.throw_dup_keys(reader,start_loc,new cljs.core.Keyword(null,"map","map",1371690461),ks_91437);
}
} else {
}
...
var vec__91201 = (edamame.impl.parser.parse_symbol.cljs$core$IFn$_invoke$arity$1 ? edamame.impl.parser.parse_symbol.cljs$core$IFn$_invoke$arity$1(token__$1) : edamame.impl.parser.parse_symbol.call(null,token__$1));
var token_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91201,(0),null);
var token_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91201,(1),null);
...
var G__91207 = c;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__91207)){
return new cljs.core.Keyword("edamame.impl.parser","eof","edamame.impl.parser/eof",720552006);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("@",G__91207)){
...
if(cljs.core.truth_(temp__5735__auto__)){
var map__91222 = temp__5735__auto__;
var map__91222__$1 = (((((!((map__91222 == null))))?(((((map__91222.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__91222.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__91222):map__91222);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__91222__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__91222__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var char$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__91222__$1,new cljs.core.Keyword(null,"char","char",-641587586));
...
return edamame.impl.parser.throw_reader.cljs$core$IFn$_invoke$arity$4(reader,["Unmatched delimiter: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(c),(cljs.core.truth_(expected)?[", expected: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expected),(function (){var temp__5735__auto__ = new cljs.core.Keyword("edamame.impl.parser","opened-delimiter","edamame.impl.parser/opened-delimiter",1199661648).cljs$core$IFn$_invoke$arity$1(ctx);
if(cljs.core.truth_(temp__5735__auto__)){
var map__91239 = temp__5735__auto__;
var map__91239__$1 = (((((!((map__91239 == null))))?(((((map__91239.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__91239.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__91239):map__91239);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__91239__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__91239__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var char$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__91239__$1,new cljs.core.Keyword(null,"char","char",-641587586));
return [" to match ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(char$)," at ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [row,col], null))].join('');
} else {
return null;
}
...
return edamame.impl.parser.throw_reader.cljs$core$IFn$_invoke$arity$4(reader,["Unmatched delimiter: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(c),(cljs.core.truth_(expected)?[", expected: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expected),(function (){var temp__5735__auto__ = new cljs.core.Keyword("edamame.impl.parser","opened-delimiter","edamame.impl.parser/opened-delimiter",1199661648).cljs$core$IFn$_invoke$arity$1(ctx);
if(cljs.core.truth_(temp__5735__auto__)){
var map__91251 = temp__5735__auto__;
...
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__91251__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__91251__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var char$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__91251__$1,new cljs.core.Keyword(null,"char","char",-641587586));
return [" to match ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(char$)," at ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [row,col], null))].join('');
} else {
return null;
}
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(obj,(function (p1__91282_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(p1__91282_SHARP_,new cljs.core.Keyword(null,"row-key","row-key",-1189010712).cljs$core$IFn$_invoke$arity$1(ctx),new cljs.core.Keyword(null,"row","row",-570139521).cljs$core$IFn$_invoke$arity$1(loc),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"col-key","col-key",-2009675766).cljs$core$IFn$_invoke$arity$1(ctx),new cljs.core.Keyword(null,"col","col",-1959363084).cljs$core$IFn$_invoke$arity$1(loc),new cljs.core.Keyword(null,"end-row-key","end-row-key",-1126662680).cljs$core$IFn$_invoke$arity$1(ctx),new cljs.core.Keyword(null,"row","row",-570139521).cljs$core$IFn$_invoke$arity$1(end_loc),new cljs.core.Keyword(null,"end-col-key","end-col-key",81813304).cljs$core$IFn$_invoke$arity$1(ctx),new cljs.core.Keyword(null,"col","col",-1959363084).cljs$core$IFn$_invoke$arity$1(end_loc)], 0));
}));
} else {
return obj;
}
...
(edamame.impl.parser.Options.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k91300,else__4383__auto__){
var self__ = this;
var this__4382__auto____$1 = this;
var G__91316 = k91300;
var G__91316__$1 = (((G__91316 instanceof cljs.core.Keyword))?G__91316.fqn:null);
switch (G__91316__$1) {
case "dispatch":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k91300,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__91319){
var vec__91323 = p__91319;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91323,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91323,(1),null);
...
(edamame.impl.parser.Options.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this91301,other91302){
var self__ = this;
var this91301__$1 = this;
return (((!((other91302 == null)))) && ((this91301__$1.constructor === other91302.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this91301__$1.dispatch,other91302.dispatch)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this91301__$1.deref,other91302.deref)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this91301__$1.syntax_quote,other91302.syntax_quote)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this91301__$1.unquote,other91302.unquote)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this91301__$1.unquote_splicing,other91302.unquote_splicing)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this91301__$1.quote,other91302.quote)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this91301__$1.fn,other91302.fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this91301__$1.var,other91302.var)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this91301__$1.read_eval,other91302.read_eval)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this91301__$1.regex,other91302.regex)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this91301__$1.row_key,other91302.row_key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this91301__$1.col_key,other91302.col_key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this91301__$1.end_row_key,other91302.end_row_key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this91301__$1.end_col_key,other91302.end_col_key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this91301__$1.__extmap,other91302.__extmap)));
}));
...
(edamame.impl.parser.Options.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__91299){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__91347 = cljs.core.keyword_identical_QMARK_;
var expr__91348 = k__4388__auto__;
if(cljs.core.truth_((pred__91347.cljs$core$IFn$_invoke$arity$2 ? pred__91347.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"dispatch","dispatch",1319337009),expr__91348) : pred__91347.call(null,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009),expr__91348)))){
return (new edamame.impl.parser.Options(G__91299,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__91347.cljs$core$IFn$_invoke$arity$2 ? pred__91347.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"deref","deref",-145586795),expr__91348) : pred__91347.call(null,new cljs.core.Keyword(null,"deref","deref",-145586795),expr__91348)))){
return (new edamame.impl.parser.Options(self__.dispatch,G__91299,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__91347.cljs$core$IFn$_invoke$arity$2 ? pred__91347.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"syntax-quote","syntax-quote",-1233164847),expr__91348) : pred__91347.call(null,new cljs.core.Keyword(null,"syntax-quote","syntax-quote",-1233164847),expr__91348)))){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,G__91299,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__91347.cljs$core$IFn$_invoke$arity$2 ? pred__91347.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"unquote","unquote",1649741032),expr__91348) : pred__91347.call(null,new cljs.core.Keyword(null,"unquote","unquote",1649741032),expr__91348)))){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,G__91299,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__91347.cljs$core$IFn$_invoke$arity$2 ? pred__91347.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"unquote-splicing","unquote-splicing",1295267556),expr__91348) : pred__91347.call(null,new cljs.core.Keyword(null,"unquote-splicing","unquote-splicing",1295267556),expr__91348)))){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,G__91299,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__91347.cljs$core$IFn$_invoke$arity$2 ? pred__91347.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"quote","quote",-262615245),expr__91348) : pred__91347.call(null,new cljs.core.Keyword(null,"quote","quote",-262615245),expr__91348)))){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,G__91299,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__91347.cljs$core$IFn$_invoke$arity$2 ? pred__91347.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"fn","fn",-1175266204),expr__91348) : pred__91347.call(null,new cljs.core.Keyword(null,"fn","fn",-1175266204),expr__91348)))){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,G__91299,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__91347.cljs$core$IFn$_invoke$arity$2 ? pred__91347.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"var","var",-769682797),expr__91348) : pred__91347.call(null,new cljs.core.Keyword(null,"var","var",-769682797),expr__91348)))){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,G__91299,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__91347.cljs$core$IFn$_invoke$arity$2 ? pred__91347.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"read-eval","read-eval",1788733932),expr__91348) : pred__91347.call(null,new cljs.core.Keyword(null,"read-eval","read-eval",1788733932),expr__91348)))){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,G__91299,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__91347.cljs$core$IFn$_invoke$arity$2 ? pred__91347.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"regex","regex",939488856),expr__91348) : pred__91347.call(null,new cljs.core.Keyword(null,"regex","regex",939488856),expr__91348)))){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,G__91299,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__91347.cljs$core$IFn$_invoke$arity$2 ? pred__91347.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"row-key","row-key",-1189010712),expr__91348) : pred__91347.call(null,new cljs.core.Keyword(null,"row-key","row-key",-1189010712),expr__91348)))){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,G__91299,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__91347.cljs$core$IFn$_invoke$arity$2 ? pred__91347.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"col-key","col-key",-2009675766),expr__91348) : pred__91347.call(null,new cljs.core.Keyword(null,"col-key","col-key",-2009675766),expr__91348)))){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,G__91299,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__91347.cljs$core$IFn$_invoke$arity$2 ? pred__91347.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"end-row-key","end-row-key",-1126662680),expr__91348) : pred__91347.call(null,new cljs.core.Keyword(null,"end-row-key","end-row-key",-1126662680),expr__91348)))){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,G__91299,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__91347.cljs$core$IFn$_invoke$arity$2 ? pred__91347.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"end-col-key","end-col-key",81813304),expr__91348) : pred__91347.call(null,new cljs.core.Keyword(null,"end-col-key","end-col-key",81813304),expr__91348)))){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,G__91299,self__.__meta,self__.__extmap,null));
} else {
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__91299),null));
}
}
}
}
...
(edamame.impl.parser.Options.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__91299){
var self__ = this;
var this__4379__auto____$1 = this;
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,G__91299,self__.__extmap,self__.__hash));
}));
 ...
 */
edamame.impl.parser.map__GT_Options = (function edamame$impl$parser$map__GT_Options(G__91307){
var extmap__4419__auto__ = (function (){var G__91357 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__91307,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"deref","deref",-145586795),new cljs.core.Keyword(null,"syntax-quote","syntax-quote",-1233164847),new cljs.core.Keyword(null,"unquote","unquote",1649741032),new cljs.core.Keyword(null,"unquote-splicing","unquote-splicing",1295267556),new cljs.core.Keyword(null,"quote","quote",-262615245),new cljs.core.Keyword(null,"fn","fn",-1175266204),new cljs.core.Keyword(null,"var","var",-769682797),new cljs.core.Keyword(null,"read-eval","read-eval",1788733932),new cljs.core.Keyword(null,"regex","regex",939488856),new cljs.core.Keyword(null,"row-key","row-key",-1189010712),new cljs.core.Keyword(null,"col-key","col-key",-2009675766),new cljs.core.Keyword(null,"end-row-key","end-row-key",-1126662680),new cljs.core.Keyword(null,"end-col-key","end-col-key",81813304)], 0));
if(cljs.core.record_QMARK_(G__91307)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__91357);
} else {
return G__91357;
}
})();
return (new edamame.impl.parser.Options(new cljs.core.Keyword(null,"dispatch","dispatch",1319337009).cljs$core$IFn$_invoke$arity$1(G__91307),new cljs.core.Keyword(null,"deref","deref",-145586795).cljs$core$IFn$_invoke$arity$1(G__91307),new cljs.core.Keyword(null,"syntax-quote","syntax-quote",-1233164847).cljs$core$IFn$_invoke$arity$1(G__91307),new cljs.core.Keyword(null,"unquote","unquote",1649741032).cljs$core$IFn$_invoke$arity$1(G__91307),new cljs.core.Keyword(null,"unquote-splicing","unquote-splicing",1295267556).cljs$core$IFn$_invoke$arity$1(G__91307),new cljs.core.Keyword(null,"quote","quote",-262615245).cljs$core$IFn$_invoke$arity$1(G__91307),new cljs.core.Keyword(null,"fn","fn",-1175266204).cljs$core$IFn$_invoke$arity$1(G__91307),new cljs.core.Keyword(null,"var","var",-769682797).cljs$core$IFn$_invoke$arity$1(G__91307),new cljs.core.Keyword(null,"read-eval","read-eval",1788733932).cljs$core$IFn$_invoke$arity$1(G__91307),new cljs.core.Keyword(null,"regex","regex",939488856).cljs$core$IFn$_invoke$arity$1(G__91307),new cljs.core.Keyword(null,"row-key","row-key",-1189010712).cljs$core$IFn$_invoke$arity$1(G__91307),new cljs.core.Keyword(null,"col-key","col-key",-2009675766).cljs$core$IFn$_invoke$arity$1(G__91307),new cljs.core.Keyword(null,"end-row-key","end-row-key",-1126662680).cljs$core$IFn$_invoke$arity$1(G__91307),new cljs.core.Keyword(null,"end-col-key","end-col-key",81813304).cljs$core$IFn$_invoke$arity$1(G__91307),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var opts__$3 = (function (){var G__91363 = opts__$2;
var G__91363__$1 = ((cljs.core.not(new cljs.core.Keyword(null,"row-key","row-key",-1189010712).cljs$core$IFn$_invoke$arity$1(opts__$2)))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__91363,new cljs.core.Keyword(null,"row-key","row-key",-1189010712),new cljs.core.Keyword(null,"row","row",-570139521)):G__91363);
var G__91363__$2 = ((cljs.core.not(new cljs.core.Keyword(null,"end-row-key","end-row-key",-1126662680).cljs$core$IFn$_invoke$arity$1(opts__$2)))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__91363__$1,new cljs.core.Keyword(null,"end-row-key","end-row-key",-1126662680),new cljs.core.Keyword(null,"end-row","end-row",-545103581)):G__91363__$1);
var G__91363__$3 = ((cljs.core.not(new cljs.core.Keyword(null,"col-key","col-key",-2009675766).cljs$core$IFn$_invoke$arity$1(opts__$2)))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__91363__$2,new cljs.core.Keyword(null,"col-key","col-key",-2009675766),new cljs.core.Keyword(null,"col","col",-1959363084)):G__91363__$2);
if(cljs.core.not(new cljs.core.Keyword(null,"end-col-key","end-col-key",81813304).cljs$core$IFn$_invoke$arity$1(opts__$2))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__91363__$3,new cljs.core.Keyword(null,"end-col-key","end-col-key",81813304),new cljs.core.Keyword(null,"end-col","end-col",-724155879));
} else {
return G__91363__$3;
}
})();
...
var G__91452 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,next_val);
ret = G__91452;
continue;
}
break;
