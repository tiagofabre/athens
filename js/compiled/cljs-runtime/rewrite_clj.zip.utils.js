...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__50606,k,f){
var vec__50607 = p__50606;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50607,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50607,(1),null);
var loc = vec__50607;
...
var G__50656 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__50656;
continue;
}
break;
...
var G__50658 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__50658;
continue;
} else {
return zloc__$1;
...
var G__50659 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__50659;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__50614){
var vec__50616 = p__50614;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50616,(0),null);
var map__50619 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50616,(1),null);
...
var path = map__50619__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50619__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__50616;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__50623){
var vec__50624 = p__50623;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50624,(0),null);
...
var path = map__50627__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50627__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__50624;
if(cljs.core.seq(r)){
...
var vec__50634 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50634,(0),null);
var map__50637 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50634,(1),null);
var map__50637__$1 = (((((!((map__50637 == null))))?(((((map__50637.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50637.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__50637):map__50637);
var path = map__50637__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50637__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50637__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50637__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50637__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
