...
var G__64123 = cljs.core.first(poshdb);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64123__$1)].join('')));
...
var G__64161 = cljs.core.cons(pdb,path);
var G__64162 = posh.lib.db.get_parent_db(pdb);
path = G__64161;
pdb = G__64162;
continue;
} else {
...
var G__64163 = posh.lib.db.get_parent_db(poshdb);
poshdb = G__64163;
continue;
}
break;
...
var filter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64132__$1,new cljs.core.Keyword(null,"filter","filter",-948537934));
var as_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64132__$1,new cljs.core.Keyword(null,"as-of","as-of",-1841962382));
var since = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64132__$1,new cljs.core.Keyword(null,"since","since",315379842));
var with$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64132__$1,new cljs.core.Keyword(null,"with","with",-1536296876));
var db__$1 = (function (){var or__4126__auto__ = db;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
var fexpr__64136 = new cljs.core.Keyword(null,"db","db",993250759).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__64136.cljs$core$IFn$_invoke$arity$1 ? fexpr__64136.cljs$core$IFn$_invoke$arity$1(conn) : fexpr__64136.call(null,conn));
}
})();
var db__$2 = (cljs.core.truth_(since)?(function (){var fexpr__64137 = new cljs.core.Keyword(null,"since","since",315379842).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__64137.cljs$core$IFn$_invoke$arity$2 ? fexpr__64137.cljs$core$IFn$_invoke$arity$2(db__$1,since) : fexpr__64137.call(null,db__$1,since));
})():db__$1);
var db__$3 = (cljs.core.truth_(as_of)?(function (){var fexpr__64138 = new cljs.core.Keyword(null,"as-of","as-of",-1841962382).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__64138.cljs$core$IFn$_invoke$arity$2 ? fexpr__64138.cljs$core$IFn$_invoke$arity$2(db__$2,as_of) : fexpr__64138.call(null,db__$2,as_of));
})():db__$2);
var db__$4 = (cljs.core.truth_(with$)?new cljs.core.Keyword(null,"db-after","db-after",-571884666).cljs$core$IFn$_invoke$arity$1((function (){var fexpr__64139 = new cljs.core.Keyword(null,"with","with",-1536296876).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__64139.cljs$core$IFn$_invoke$arity$2 ? fexpr__64139.cljs$core$IFn$_invoke$arity$2(db__$3,with$) : fexpr__64139.call(null,db__$3,with$));
})()):db__$3);
var db__$5 = (cljs.core.truth_(filter)?(function (){var G__64141 = db__$4;
var G__64142 = (((filter instanceof cljs.core.Symbol))?null:filter);
var fexpr__64140 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__64140.cljs$core$IFn$_invoke$arity$2 ? fexpr__64140.cljs$core$IFn$_invoke$arity$2(G__64141,G__64142) : fexpr__64140.call(null,G__64141,G__64142));
})():db__$4);
return db__$5;
}));
...
posh.lib.db.poshdb__GT_db = (function posh$lib$db$poshdb__GT_db(p__64146,poshdb){
...
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64147__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64147__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(poshdb),new cljs.core.Keyword(null,"db","db",993250759))){
return posh.lib.db.db_id__GT_db(posh_tree,cljs.core.second(poshdb));
} else {
var G__64150 = (function (){var G__64152 = posh_tree;
var G__64153 = posh.lib.db.get_parent_db(poshdb);
return (posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2 ? posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2(G__64152,G__64153) : posh.lib.db.poshdb__GT_db.call(null,G__64152,G__64153));
})();
var G__64151 = posh.lib.db.make_filter_pred(new cljs.core.Keyword(null,"pass-patterns","pass-patterns",1090887263).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cache,poshdb)));
var fexpr__64149 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__64149.cljs$core$IFn$_invoke$arity$2 ? fexpr__64149.cljs$core$IFn$_invoke$arity$2(G__64150,G__64151) : fexpr__64149.call(null,G__64150,G__64151));
}
});
