...
var G__72192 = new cljs.core.Keyword(null,"reduction-type","reduction-type",-488293450).cljs$core$IFn$_invoke$arity$1(f);
var G__72192__$1 = (((G__72192 instanceof cljs.core.Keyword))?G__72192.fqn:null);
switch (G__72192__$1) {
case "raw":
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4529__auto__ = (function instaparse$reduction$iter__72196(s__72197){
return (new cljs.core.LazySeq(null,(function (){
var s__72197__$1 = s__72197;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__72197__$1);
if(temp__5735__auto__){
var s__72197__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__72197__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__72197__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__72199 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__72198 = (0);
while(true){
if((i__72198 < size__4528__auto__)){
var vec__72208 = cljs.core._nth(c__4527__auto__,i__72198);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72208,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72208,(1),null);
cljs.core.chunk_append(b__72199,(cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)));

var G__72222 = (i__72198 + (1));
i__72198 = G__72222;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__72199),instaparse$reduction$iter__72196(cljs.core.chunk_rest(s__72197__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__72199),null);
}
} else {
var vec__72212 = cljs.core.first(s__72197__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72212,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__72212,(1),null);
return cljs.core.cons((cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)),instaparse$reduction$iter__72196(cljs.core.rest(s__72197__$2)));
}
} else {
return null;
}
