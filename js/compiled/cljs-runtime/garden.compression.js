 ...
 */
garden.compression.token_fn = (function garden$compression$token_fn(p__85926){
var vec__85927 = p__85926;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85927,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85927,(1),null);
return (function (s){
...
var len__4736__auto___85962 = arguments.length;
var i__4737__auto___85963 = (0);
while(true){
if((i__4737__auto___85963 < len__4736__auto___85962)){
args__4742__auto__.push((arguments[i__4737__auto___85963]));

var G__85965 = (i__4737__auto___85963 + (1));
i__4737__auto___85963 = G__85965;
continue;
} else {
}
break;
...
return (function (s){
return cljs.core.some((function (p1__85934_SHARP_){
return (p1__85934_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__85934_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__85934_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(garden.compression.tokenizer.cljs$lang$applyTo = (function (seq85937){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq85937));
}));
...
var map__85952 = temp__5733__auto__;
var map__85952__$1 = (((((!((map__85952 == null))))?(((((map__85952.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__85952.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__85952):map__85952);
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85952__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85952__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85952__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__85972 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__85973 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__85958 = tag;
var G__85958__$1 = (((G__85958 instanceof cljs.core.Keyword))?G__85958.fqn:null);
switch (G__85958__$1) {
case "string":
return chunk;
