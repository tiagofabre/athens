 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.compression.token_fn = (function day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$compression$token_fn(p__46884){
var vec__46886 = p__46884;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46886,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46886,(1),null);
return (function (s){
...
var len__4736__auto___46920 = arguments.length;
var i__4737__auto___46921 = (0);
while(true){
if((i__4737__auto___46921 < len__4736__auto___46920)){
args__4742__auto__.push((arguments[i__4737__auto___46921]));

var G__46922 = (i__4737__auto___46921 + (1));
i__4737__auto___46921 = G__46922;
continue;
} else {
}
break;
...
return (function (s){
return cljs.core.some((function (p1__46889_SHARP_){
return (p1__46889_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__46889_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__46889_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq46890){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq46890));
}));
...
var map__46902 = temp__5733__auto__;
...
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46902__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46902__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46902__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__46937 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__46938 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__46910 = tag;
var G__46910__$1 = (((G__46910 instanceof cljs.core.Keyword))?G__46910.fqn:null);
switch (G__46910__$1) {
case "string":
return chunk;
