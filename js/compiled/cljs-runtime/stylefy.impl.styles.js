...
stylefy.impl.styles.create_style_BANG_ = (function stylefy$impl$styles$create_style_BANG_(p__88934,style_created_handler){
var map__88935 = p__88934;
var map__88935__$1 = (((((!((map__88935 == null))))?(((((map__88935.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__88935.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__88935):map__88935);
var style = map__88935__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88935__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88935__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var style_css = stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$1(style);
var G__88937_88989 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__88937_88989) : style_created_handler.call(null,G__88937_88989));

var seq__88938 = cljs.core.seq(cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(props)));
var chunk__88939 = null;
var count__88940 = (0);
var i__88941 = (0);
while(true){
if((i__88941 < count__88940)){
var sub_style = chunk__88939.cljs$core$IIndexed$_nth$arity$2(null,i__88941);
var G__88946_88991 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__88947_88992 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__88946_88991,G__88947_88992) : stylefy.impl.styles.create_style_BANG_.call(null,G__88946_88991,G__88947_88992));


var G__88994 = seq__88938;
var G__88995 = chunk__88939;
var G__88996 = count__88940;
var G__88997 = (i__88941 + (1));
seq__88938 = G__88994;
chunk__88939 = G__88995;
count__88940 = G__88996;
i__88941 = G__88997;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__88938);
if(temp__5735__auto__){
var seq__88938__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__88938__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__88938__$1);
var G__88998 = cljs.core.chunk_rest(seq__88938__$1);
var G__88999 = c__4556__auto__;
var G__89000 = cljs.core.count(c__4556__auto__);
var G__89001 = (0);
seq__88938 = G__88998;
chunk__88939 = G__88999;
count__88940 = G__89000;
i__88941 = G__89001;
continue;
} else {
var sub_style = cljs.core.first(seq__88938__$1);
var G__88948_89002 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__88949_89003 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__88948_89002,G__88949_89003) : stylefy.impl.styles.create_style_BANG_.call(null,G__88948_89002,G__88949_89003));


var G__89004 = cljs.core.next(seq__88938__$1);
var G__89005 = null;
var G__89006 = (0);
var G__89007 = (0);
seq__88938 = G__89004;
chunk__88939 = G__89005;
count__88940 = G__89006;
i__88941 = G__89007;
continue;
}
} else {
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__88954_SHARP_){
return ((typeof p1__88954_SHARP_ === 'string') || ((p1__88954_SHARP_ instanceof cljs.core.Keyword)) || ((p1__88954_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__88954#] (or (string? p1__88954#) (keyword? p1__88954#) (nil? p1__88954#))) class)))"].join('')));
}
});
/**
...
var len__4736__auto___89024 = arguments.length;
var i__4737__auto___89025 = (0);
while(true){
if((i__4737__auto___89025 < len__4736__auto___89024)){
args__4742__auto__.push((arguments[i__4737__auto___89025]));

var G__89026 = (i__4737__auto___89025 + (1));
i__4737__auto___89025 = G__89026;
continue;
} else {
}
break;
...
var resolved_sub_style = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__88967_SHARP_,p2__88968_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__88967_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432),p2__88968_SHARP_], null));
}),style,sub_styles);
if(cljs.core.truth_(resolved_sub_style)){
...
/** @this {Function} */
(stylefy.impl.styles.sub_style.cljs$lang$applyTo = (function (seq88970){
var G__88971 = cljs.core.first(seq88970);
var seq88970__$1 = cljs.core.next(seq88970);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__88971,seq88970__$1);
}));

stylefy.impl.styles.prepare_styles = (function stylefy$impl$styles$prepare_styles(var_args){
var G__88974 = arguments.length;
switch (G__88974) {
case 1:
...
(stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2 = (function (styles,p__88975){
var map__88976 = p__88975;
var map__88976__$1 = (((((!((map__88976 == null))))?(((((map__88976.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__88976.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__88976):map__88976);
var options = map__88976__$1;
var request_dom_update_after_done_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88976__$1,new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510));
var styles_89035__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__88978_89036 = cljs.core.seq(styles_89035__$1);
var chunk__88979_89037 = null;
var count__88980_89038 = (0);
var i__88981_89039 = (0);
while(true){
if((i__88981_89039 < count__88980_89038)){
var style_89040 = chunk__88979_89037.cljs$core$IIndexed$_nth$arity$2(null,i__88981_89039);
stylefy.impl.styles.use_style_BANG_(style_89040,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___89041 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_89040));
if(cljs.core.truth_(temp__5735__auto___89041)){
var sub_styles_89042 = temp__5735__auto___89041;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_89042,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__89046 = seq__88978_89036;
var G__89047 = chunk__88979_89037;
var G__89048 = count__88980_89038;
var G__89049 = (i__88981_89039 + (1));
seq__88978_89036 = G__89046;
chunk__88979_89037 = G__89047;
count__88980_89038 = G__89048;
i__88981_89039 = G__89049;
continue;
} else {
var temp__5735__auto___89051 = cljs.core.seq(seq__88978_89036);
if(temp__5735__auto___89051){
var seq__88978_89053__$1 = temp__5735__auto___89051;
if(cljs.core.chunked_seq_QMARK_(seq__88978_89053__$1)){
var c__4556__auto___89054 = cljs.core.chunk_first(seq__88978_89053__$1);
var G__89055 = cljs.core.chunk_rest(seq__88978_89053__$1);
var G__89056 = c__4556__auto___89054;
var G__89057 = cljs.core.count(c__4556__auto___89054);
var G__89058 = (0);
seq__88978_89036 = G__89055;
chunk__88979_89037 = G__89056;
count__88980_89038 = G__89057;
i__88981_89039 = G__89058;
continue;
} else {
var style_89060 = cljs.core.first(seq__88978_89053__$1);
stylefy.impl.styles.use_style_BANG_(style_89060,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___89063__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_89060));
if(cljs.core.truth_(temp__5735__auto___89063__$1)){
var sub_styles_89064 = temp__5735__auto___89063__$1;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_89064,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__89065 = cljs.core.next(seq__88978_89053__$1);
var G__89066 = null;
var G__89067 = (0);
var G__89068 = (0);
seq__88978_89036 = G__89065;
chunk__88979_89037 = G__89066;
count__88980_89038 = G__89067;
i__88981_89039 = G__89068;
continue;
}
} else {
}
