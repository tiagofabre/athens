...
sci.impl.interop.get_static_field = (function sci$impl$interop$get_static_field(p__90636){
var vec__90637 = p__90636;
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__90637,(0),null);
var field_name_sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__90637,(1),null);
...
sci.impl.interop.invoke_static_method = (function sci$impl$interop$invoke_static_method(p__90647,args){
var vec__90649 = p__90647;
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__90649,(0),null);
var method_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__90649,(1),null);
...
var vec__90652 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(method_name__$1,/\./);
var field = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__90652,(0),null);
var sub_method_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__90652,(1),null);
...
sci.impl.interop.fully_qualify_class = (function sci$impl$interop$fully_qualify_class(p__90664,sym){
var map__90666 = p__90664;
var map__90666__$1 = (((((!((map__90666 == null))))?(((((map__90666.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__90666.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__90666):map__90666);
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90666__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var class__GT_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90666__$1,new cljs.core.Keyword(null,"class->opts","class->opts",2061906477));
...
sci.impl.interop.resolve_class_opts = (function sci$impl$interop$resolve_class_opts(p__90675,sym){
var map__90677 = p__90675;
var map__90677__$1 = (((((!((map__90677 == null))))?(((((map__90677.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__90677.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__90677):map__90677);
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90677__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var class__GT_opts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__90677__$1,new cljs.core.Keyword(null,"class->opts","class->opts",2061906477));
