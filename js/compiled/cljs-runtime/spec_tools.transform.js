...
if((x instanceof cljs.core.Keyword)){
var G__83134 = spec;
var G__83135 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__83134,G__83135) : f.call(null,G__83134,G__83135));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__83139 = spec;
var G__83140 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__83139,G__83140) : f.call(null,G__83139,G__83140));
} else {
return x;
...
}catch (e83142){if((e83142 instanceof Error)){
var ___$1 = e83142;
return x;
} else {
throw e83142;
...
}catch (e83147){if((e83147 instanceof Error)){
var ___$1 = e83147;
return x;
} else {
throw e83147;
...
}catch (e83151){if((e83151 instanceof Error)){
var ___$1 = e83151;
return x;
} else {
throw e83151;
...
}catch (e83158){if((e83158 instanceof Error)){
var ___$1 = e83158;
return x;
} else {
throw e83158;
...
}catch (e83159){if((e83159 instanceof Error)){
var ___$1 = e83159;
return x;
} else {
throw e83159;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__83163,x){
var map__83165 = p__83163;
var map__83165__$1 = (((((!((map__83165 == null))))?(((((map__83165.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__83165.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__83165):map__83165);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83165__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__83172,x){
var map__83173 = p__83172;
var map__83173__$1 = (((((!((map__83173 == null))))?(((((map__83173.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__83173.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__83173):map__83173);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83173__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__83176,x){
var map__83177 = p__83176;
var map__83177__$1 = (((((!((map__83177 == null))))?(((((map__83177.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__83177.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__83177):map__83177);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__83177__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
