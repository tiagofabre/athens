...
var G__50479 = clojure.zip.node(loc);
var fexpr__50478 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__50478.cljs$core$IFn$_invoke$arity$1 ? fexpr__50478.cljs$core$IFn$_invoke$arity$1(G__50479) : fexpr__50478.call(null,G__50479));
});
/**
...
var G__50483 = clojure.zip.node(loc);
var fexpr__50482 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
...
var fexpr__50486 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__50486.cljs$core$IFn$_invoke$arity$2 ? fexpr__50486.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__50486.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__50491 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50491,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50491,(1),null);
var vec__50494 = clojure.zip.children(loc);
var seq__50495 = cljs.core.seq(vec__50494);
var first__50496 = cljs.core.first(seq__50495);
var seq__50495__$1 = cljs.core.next(seq__50495);
var c = first__50496;
var cnext = seq__50495__$1;
var cs = vec__50494;
...
var vec__50497 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50497,(0),null);
var map__50500 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50497,(1),null);
...
var path = map__50500__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50500__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50500__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50500__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50500__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50500__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__50505 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50505,(0),null);
var map__50508 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50505,(1),null);
...
var path = map__50508__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50508__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__50509 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50508__$1,new cljs.core.Keyword(null,"r","r",-471384190));
...
var vec__50516 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50516,(0),null);
var map__50519 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50516,(1),null);
...
var path = map__50519__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50519__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50519__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4115__auto__ = path;
if(cljs.core.truth_(and__4115__auto__)){
return r;
} else {
...
var vec__50521 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50521,(0),null);
var map__50524 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50521,(1),null);
...
var path = map__50524__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50524__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50524__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4115__auto__ = path;
if(cljs.core.truth_(and__4115__auto__)){
...
var vec__50526 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50526,(0),null);
var map__50529 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50526,(1),null);
...
var path = map__50529__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50529__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50529__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4115__auto__ = path;
if(cljs.core.truth_(and__4115__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__50532 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50532,(0),null);
var map__50535 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50532,(1),null);
...
var path = map__50535__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50535__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__50540 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50540,(0),null);
...
var path = map__50543__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50543__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__50545 = loc;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50545,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50545,(1),null);
...
var len__4736__auto___50629 = arguments.length;
var i__4737__auto___50630 = (0);
while(true){
if((i__4737__auto___50630 < len__4736__auto___50629)){
args__4742__auto__.push((arguments[i__4737__auto___50630]));

var G__50631 = (i__4737__auto___50630 + (1));
i__4737__auto___50630 = G__50631;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq50548){
var G__50549 = cljs.core.first(seq50548);
var seq50548__$1 = cljs.core.next(seq50548);
var G__50550 = cljs.core.first(seq50548__$1);
var seq50548__$2 = cljs.core.next(seq50548__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50549,G__50550,seq50548__$2);
}));
...
var G__50642 = clojure.zip.rightmost(child);
loc__$1 = G__50642;
continue;
} else {
return loc__$1;
...
var vec__50575 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50575,(0),null);
var map__50578 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50575,(1),null);
...
var path = map__50578__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50578__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50578__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50578__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50578__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__50657 = clojure.zip.rightmost(child);
loc__$1 = G__50657;
continue;
} else {
return loc__$1;
