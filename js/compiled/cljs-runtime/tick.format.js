...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__71859 = goog.object.get(JSJodaLocale,"Locale");
if((G__71859 == null)){
return null;
} else {
return goog.object.get(G__71859,"US");
}
}catch (e71858){if((e71858 instanceof Error)){
var e = e71858;
return null;
} else {
throw e71858;
