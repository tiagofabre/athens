...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__89114){
var vec__89116 = p__89114;
var color_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__89116,(0),null);
var color_v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__89116,(1),null);
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(["--",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(color_k))].join('')),color_v], null),cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__89119){
var vec__89120 = p__89119;
var opacity_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__89120,(0),null);
var opacity_v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__89120,(1),null);
...
var permute_light_89150 = athens.style.permute_color_opacities(athens.style.THEME_LIGHT);
var permute_dark_89152 = athens.style.permute_color_opacities(athens.style.THEME_DARK);
stylefy.core.tag(":root",cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([permute_light_89150,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("stylefy.core","media","stylefy.core/media",-1323617834),cljs.core.PersistentArrayMap.createAsIfByAssoc([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"prefers-color-scheme","prefers-color-scheme",-1885369990),"dark"], null),permute_dark_89152])], null)], 0)));
