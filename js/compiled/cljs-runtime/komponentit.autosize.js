...
komponentit.autosize.apply_box_sizing = (function komponentit$autosize$apply_box_sizing(value,p__89008){
var map__89009 = p__89008;
var map__89009__$1 = (((((!((map__89009 == null))))?(((((map__89009.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__89009.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__89009):map__89009);
var box_sizing = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89009__$1,new cljs.core.Keyword(null,"box-sizing","box-sizing",-1956090239));
var border_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89009__$1,new cljs.core.Keyword(null,"border-size","border-size",991975640));
var padding_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89009__$1,new cljs.core.Keyword(null,"padding-size","padding-size",-733651675));
var G__89013 = box_sizing;
switch (G__89013) {
case "border-box":
...
var G__89018 = document.createElement("div");
document.body.appendChild(G__89018);

return G__89018;
}),null));
}
komponentit.autosize.node_width = (function komponentit$autosize$node_width(value,placeholder,placeholder_is_min_width_QMARK_,p__89019){
...
var styles = map__89020__$1;
var sizer_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89020__$1,new cljs.core.Keyword(null,"sizer-style","sizer-style",-1176226328));
 ...
 */
komponentit.autosize.input = (function komponentit$autosize$input(p__89027){
var map__89028 = p__89027;
var map__89028__$1 = (((((!((map__89028 == null))))?(((((map__89028.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__89028.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__89028):map__89028);
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89028__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var placeholder_is_min_width_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89028__$1,new cljs.core.Keyword(null,"placeholder-is-min-width?","placeholder-is-min-width?",-1743052093));
...
}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (this$,p__89031){
var vec__89032 = p__89031;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__89032,(0),null);
var prev_props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__89032,(1),null);
...
}),new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),(function (p__89043){
var map__89044 = p__89043;
var map__89044__$1 = (((((!((map__89044 == null))))?(((((map__89044.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__89044.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__89044):map__89044);
var props = map__89044__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89044__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89044__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89044__$1,new cljs.core.Keyword(null,"value","value",305978217));
var placeholder__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89044__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
...
var G__89073 = document.createElement("div");
document.body.appendChild(G__89073);

return G__89073;
}),null));
}
komponentit.autosize.node_height = (function komponentit$autosize$node_height(value,min_rows,max_rows,p__89074){
var map__89075 = p__89074;
var map__89075__$1 = (((((!((map__89075 == null))))?(((((map__89075.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__89075.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__89075):map__89075);
var styles = map__89075__$1;
var box_sizing = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89075__$1,new cljs.core.Keyword(null,"box-sizing","box-sizing",-1956090239));
var border_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89075__$1,new cljs.core.Keyword(null,"border-size","border-size",991975640));
var padding_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89075__$1,new cljs.core.Keyword(null,"padding-size","padding-size",-733651675));
var sizer_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89075__$1,new cljs.core.Keyword(null,"sizer-style","sizer-style",-1176226328));
 ...
 *   component, for easier styling.
 */
komponentit.autosize.textarea = (function komponentit$autosize$textarea(p__89079){
var map__89080 = p__89079;
...
var min_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89080__$1,new cljs.core.Keyword(null,"min-rows","min-rows",1428640765));
var max_rows = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89080__$1,new cljs.core.Keyword(null,"max-rows","max-rows",-2131113613));
var state = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(null);
...
}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (this$,p__89086){
var vec__89087 = p__89086;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__89087,(0),null);
var prev_props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__89087,(1),null);
if(((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(reagent.core.props(this$)),new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(prev_props))) || (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(reagent.core.props(this$)),new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(prev_props))))){
return cljs.core.reset_BANG_(state,komponentit.autosize.textarea_node_styles(reagent.dom.dom_node(this$)));
} else {
return null;
}
}),new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),(function (p__89090){
...
var props = map__89091__$1;
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89091__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89091__$1,new cljs.core.Keyword(null,"value","value",305978217));
var min_rows__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89091__$1,new cljs.core.Keyword(null,"min-rows","min-rows",1428640765));
var max_rows__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__89091__$1,new cljs.core.Keyword(null,"max-rows","max-rows",-2131113613));
