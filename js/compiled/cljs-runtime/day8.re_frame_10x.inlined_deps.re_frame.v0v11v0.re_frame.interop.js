...
return [(function (){var pred__48207 = cljs.core.instance_QMARK_;
var expr__48208 = reactive_val;
if(cljs.core.truth_((pred__48207.cljs$core$IFn$_invoke$arity$2 ? pred__48207.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RAtom,expr__48208) : pred__48207.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RAtom,expr__48208)))){
return "ra";
} else {
if(cljs.core.truth_((pred__48207.cljs$core$IFn$_invoke$arity$2 ? pred__48207.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RCursor,expr__48208) : pred__48207.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RCursor,expr__48208)))){
return "rc";
} else {
if(cljs.core.truth_((pred__48207.cljs$core$IFn$_invoke$arity$2 ? pred__48207.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Reaction,expr__48208) : pred__48207.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Reaction,expr__48208)))){
return "rx";
} else {
if(cljs.core.truth_((pred__48207.cljs$core$IFn$_invoke$arity$2 ? pred__48207.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Track,expr__48208) : pred__48207.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Track,expr__48208)))){
return "tr";
} else {
return "other";
}
