...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42648){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42649,G__42650,seq42648__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42672_SHARP_){
return (!((cljs.core.meta(p1__42672_SHARP_) == null)));
})))){
...
}catch (e42688){var _e__41682__auto__ = e42688;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e42690){var _e__41682__auto__ = e42690;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__42694 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42695 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42695);

try{var map__42696 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42696__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42694);
}});
...
var temp__5733__auto___42762 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___42762)){
var managed_print_level_42763 = temp__5733__auto___42762;
var _STAR_print_level_STAR__orig_val__42701_42764 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42702_42765 = managed_print_level_42763;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42702_42765);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__42699_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__42699_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42701_42764);
}} else {
job_fn();
}
