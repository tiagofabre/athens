...
var G__49208 = new_next_nonws_QMARK_;
index = G__49206;
skip_to_right_QMARK_ = G__49207;
next_nonws_QMARK_ = G__49208;
continue;
}
}
break;
...
var G__49210 = zprint.focus.next_ssv(ssv,index);
var G__49211 = (moves - (1));
index = G__49210;
moves = G__49211;
continue;
}
...
var G__49215 = zprint.focus.right_ssv(cljs.core.first(nwp),ssv,zprint.focus.down_ssv(ssv,idx));
var G__49216 = cljs.core.next(nwp);
idx = G__49215;
nwp = G__49216;
continue;
}
