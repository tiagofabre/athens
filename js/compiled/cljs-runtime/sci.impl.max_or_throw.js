...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_90893 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_90893(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__90848 = (n - (1));
var G__90849 = cljs.core.rest(s);
var G__90850 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__90848,G__90849,G__90850) : sci.impl.max_or_throw.take_STAR_.call(null,G__90848,G__90849,G__90850));
})());
} else {
return null;
}
