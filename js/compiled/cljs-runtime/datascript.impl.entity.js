...
var G__71300 = db;
var G__71301 = e;
var G__71302 = cljs.core.volatile_BANG_(false);
var G__71303 = cljs.core.volatile_BANG_(cljs.core.PersistentArrayMap.EMPTY);
return (datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4 ? datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4(G__71300,G__71301,G__71302,G__71303) : datascript.impl.entity.__GT_Entity.call(null,G__71300,G__71301,G__71302,G__71303));
} else {
return null;
}
});
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__71307_SHARP_,p2__71308_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__71307_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__71308_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
} else {
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__71310_SHARP_,p2__71311_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__71310_SHARP_,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__71311_SHARP_));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
if(datascript.db.ref_QMARK_(db,a)){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__71314_SHARP_,p2__71315_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__71314_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"e","e",1381269198).cljs$core$IFn$_invoke$arity$1(p2__71315_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
return not_found;
...
var iter__4529__auto__ = (function datascript$impl$entity$js_seq_$_iter__71327(s__71328){
return (new cljs.core.LazySeq(null,(function (){
var s__71328__$1 = s__71328;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__71328__$1);
if(temp__5735__auto__){
var s__71328__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__71328__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__71328__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__71330 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__71329 = (0);
while(true){
if((i__71329 < size__4528__auto__)){
var vec__71335 = cljs.core._nth(c__4527__auto__,i__71329);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71335,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71335,(1),null);
cljs.core.chunk_append(b__71330,((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)));

var G__71501 = (i__71329 + (1));
i__71329 = G__71501;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__71330),datascript$impl$entity$js_seq_$_iter__71327(cljs.core.chunk_rest(s__71328__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__71330),null);
}
} else {
var vec__71339 = cljs.core.first(s__71328__$2);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71339,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71339,(1),null);
return cljs.core.cons(((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)),datascript$impl$entity$js_seq_$_iter__71327(cljs.core.rest(s__71328__$2)));
}
} else {
return null;
}
...
var G__71503 = null;
var G__71503__1 = (function (f){
var self__ = this;
var this$ = this;
var seq__71350 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__71351 = null;
var count__71352 = (0);
var i__71353 = (0);
while(true){
if((i__71353 < count__71352)){
var vec__71366 = chunk__71351.cljs$core$IIndexed$_nth$arity$2(null,i__71353);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71366,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71366,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null,v,a,this$));


var G__71504 = seq__71350;
var G__71505 = chunk__71351;
var G__71506 = count__71352;
var G__71507 = (i__71353 + (1));
seq__71350 = G__71504;
chunk__71351 = G__71505;
count__71352 = G__71506;
i__71353 = G__71507;
continue;
} else {
...
var G__71508 = cljs.core.chunk_rest(seq__71350__$1);
var G__71509 = c__4556__auto__;
var G__71510 = cljs.core.count(c__4556__auto__);
var G__71511 = (0);
seq__71350 = G__71508;
chunk__71351 = G__71509;
count__71352 = G__71510;
i__71353 = G__71511;
continue;
} else {
var vec__71379 = cljs.core.first(seq__71350__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71379,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71379,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null,v,a,this$));


var G__71516 = cljs.core.next(seq__71350__$1);
var G__71517 = null;
var G__71518 = (0);
var G__71519 = (0);
seq__71350 = G__71516;
chunk__71351 = G__71517;
count__71352 = G__71518;
i__71353 = G__71519;
continue;
}
} else {
...
var G__71503__2 = (function (f,use_as_this){
var self__ = this;
var this$ = this;
var seq__71383 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__71384 = null;
var count__71385 = (0);
var i__71386 = (0);
while(true){
if((i__71386 < count__71385)){
var vec__71402 = chunk__71384.cljs$core$IIndexed$_nth$arity$2(null,i__71386);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71402,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71402,(1),null);
f.call(use_as_this,v,a,this$);


var G__71521 = seq__71383;
var G__71522 = chunk__71384;
var G__71523 = count__71385;
var G__71524 = (i__71386 + (1));
seq__71383 = G__71521;
chunk__71384 = G__71522;
count__71385 = G__71523;
i__71386 = G__71524;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__71383);
if(temp__5735__auto__){
var seq__71383__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__71383__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__71383__$1);
var G__71525 = cljs.core.chunk_rest(seq__71383__$1);
var G__71526 = c__4556__auto__;
var G__71527 = cljs.core.count(c__4556__auto__);
var G__71528 = (0);
seq__71383 = G__71525;
chunk__71384 = G__71526;
count__71385 = G__71527;
i__71386 = G__71528;
continue;
} else {
var vec__71410 = cljs.core.first(seq__71383__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71410,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71410,(1),null);
f.call(use_as_this,v,a,this$);


var G__71529 = cljs.core.next(seq__71383__$1);
var G__71530 = null;
var G__71531 = (0);
var G__71532 = (0);
seq__71383 = G__71529;
chunk__71384 = G__71530;
count__71385 = G__71531;
i__71386 = G__71532;
continue;
}
} else {
...
G__71503 = function(f,use_as_this){
switch(arguments.length){
case 1:
return G__71503__1.call(this,f);
case 2:
return G__71503__2.call(this,f,use_as_this);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__71503.cljs$core$IFn$_invoke$arity$1 = G__71503__1;
G__71503.cljs$core$IFn$_invoke$arity$2 = G__71503__2;
return G__71503;
})()
);
...
var G__71416 = (datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2 ? datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$2(this$,attr) : datascript.impl.entity.lookup_entity.call(null,this$,attr));
if(datascript.db.multival_QMARK_(self__.db,attr)){
return datascript.impl.entity.multival__GT_js(G__71416);
} else {
return G__71416;
}
}
...
var self__ = this;
var self__ = this;
var G__71438 = (arguments.length - (1));
switch (G__71438) {
case (1):
...
(datascript.impl.entity.Entity.prototype.apply = (function (self__,args71346){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args71346)));
}));
...
var temp__5737__auto__ = (function (){var fexpr__71475 = cljs.core.deref(this$.cache);
return (fexpr__71475.cljs$core$IFn$_invoke$arity$1 ? fexpr__71475.cljs$core$IFn$_invoke$arity$1(attr) : fexpr__71475.call(null,attr));
})();
...
var temp__5735__auto___71555 = cljs.core.not_empty(datascript.db._search(e.db,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [e.eid], null)));
if(cljs.core.truth_(temp__5735__auto___71555)){
var datoms_71556 = temp__5735__auto___71555;
cljs.core.vreset_BANG_(e.cache,datascript.impl.entity.touch_components(e.db,datascript.impl.entity.datoms__GT_cache(e.db,datoms_71556)));
