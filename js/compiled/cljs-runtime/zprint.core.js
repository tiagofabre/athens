...
var vec__54200 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__54205 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54205,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54205,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54200,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54200,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__54209){
var vec__54210 = p__54209;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54210,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54210,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54213,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54213,(1),null);
...
var vec__54221 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54221,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54221,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54221,(2),null);
var vec__54224 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54224,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54224,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54224,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__54238){
var vec__54239 = p__54238;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54239,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54239,(1),null);
...
var len__4736__auto___54471 = arguments.length;
var i__4737__auto___54476 = (0);
while(true){
if((i__4737__auto___54476 < len__4736__auto___54471)){
args__4742__auto__.push((arguments[i__4737__auto___54476]));

var G__54477 = (i__4737__auto___54476 + (1));
i__4737__auto___54476 = G__54477;
continue;
} else {
}
break;
...
var vec__54253 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54253,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54253,(1),null);
...
var G__54256 = zprint.core.parse_string_all_options(rest_options);
var G__54257 = zprint.core.zprint_str_internal;
var G__54258 = ":parse-string-all? call";
var G__54259 = (function (){var G__54260 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__54260) : zprint.zutil.edn_STAR_.call(null,G__54260));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__54256,G__54257,G__54258,G__54259) : zprint.core.process_multiple_forms.call(null,G__54256,G__54257,G__54258,G__54259));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__54261 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54261,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54261,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq54247){
var G__54248 = cljs.core.first(seq54247);
var seq54247__$1 = cljs.core.next(seq54247);
var G__54249 = cljs.core.first(seq54247__$1);
var seq54247__$2 = cljs.core.next(seq54247__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54248,G__54249,seq54247__$2);
}));
...
var G__54513 = (i__4737__auto___54512 + (1));
i__4737__auto___54512 = G__54513;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq54266){
var G__54267 = cljs.core.first(seq54266);
var seq54266__$1 = cljs.core.next(seq54266);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54267,seq54266__$1);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___54528 = arguments.length;
var i__4737__auto___54537 = (0);
while(true){
if((i__4737__auto___54537 < len__4736__auto___54528)){
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq54276){
var G__54277 = cljs.core.first(seq54276);
var seq54276__$1 = cljs.core.next(seq54276);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54277,seq54276__$1);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___54546 = arguments.length;
var i__4737__auto___54547 = (0);
while(true){
if((i__4737__auto___54547 < len__4736__auto___54546)){
args__4742__auto__.push((arguments[i__4737__auto___54547]));

var G__54552 = (i__4737__auto___54547 + (1));
i__4737__auto___54547 = G__54552;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq54280){
var G__54281 = cljs.core.first(seq54280);
var seq54280__$1 = cljs.core.next(seq54280);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54281,seq54280__$1);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___54557 = arguments.length;
var i__4737__auto___54558 = (0);
while(true){
if((i__4737__auto___54558 < len__4736__auto___54557)){
args__4742__auto__.push((arguments[i__4737__auto___54558]));

var G__54559 = (i__4737__auto___54558 + (1));
i__4737__auto___54558 = G__54559;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq54285){
var G__54286 = cljs.core.first(seq54285);
var seq54285__$1 = cljs.core.next(seq54285);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__54286,seq54285__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__54318,form){
var vec__54321 = p__54318;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54321,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54321,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54321,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54321,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__54330 = (cljs.core.truth_((function (){var and__4115__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4115__auto__)){
if((indent === (0))){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54330,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54330,(1),null);
...
var forms = (function (){var G__54356 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__54356) : zprint.zutil.edn_STAR_.call(null,G__54356));
})();
