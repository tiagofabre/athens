...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__49218_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__49218_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__49218_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__49223){
var vec__49224 = p__49223;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49224,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49224,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__49239,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49240__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49240__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49240__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__49252 = (function (){var or__4126__auto__ = color;
...
var fexpr__49251 = (function (){var G__49253 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__49253) : style_map.call(null,G__49253));
})();
return (fexpr__49251.cljs$core$IFn$_invoke$arity$1 ? fexpr__49251.cljs$core$IFn$_invoke$arity$1(G__49252) : fexpr__49251.call(null,G__49252));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__49259){
var vec__49264 = p__49259;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49264,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49264,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49264,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__49269){
var vec__49270 = p__49269;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49270,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49270,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49270,(2),null);
...
var G__49540 = cljs.core.next(ssv);
var G__49541 = (this_ssv == null);
var G__49542 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__49543 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__49540;
doing_nil_QMARK_ = G__49541;
last_elide = G__49542;
out = G__49543;
continue;
}
...
var vec__49290 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49290,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49290,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49290,(2),null);
...
var G__49549 = cljs.core.next(remaining_cvec);
var G__49550 = new_idx;
var G__49551 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__49549;
idx = G__49550;
out = G__49551;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__49333,cursor_vec){
var vec__49335 = p__49333;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49335,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49335,(1),null);
var focus_vec = vec__49335;
...
var vec__49340 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49340,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49340,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__49358){
var vec__49360 = p__49358;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49360,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49360,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__49381,existing_count){
var vec__49382 = p__49381;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49382,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49382,(1),null);
...
return cljs.core.filterv((function (p1__49373_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__49373_SHARP_))));
...
var vec__49422 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49422,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49422,(1),null);
var cvec_element = vec__49422;
if((cvec_element == null)){
var G__49597 = cljs.core.next(cvec_nl);
var G__49598 = (idx + (1));
var G__49599 = start;
var G__49600 = out;
cvec_nl = G__49597;
...
var G__49603 = cljs.core.next(cvec_nl);
var G__49604 = (idx + (1));
var G__49605 = idx;
var G__49606 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__49603;
idx = G__49604;
start = G__49605;
out = G__49606;
...
var G__49607 = cljs.core.next(cvec_nl);
var G__49608 = (idx + (1));
var G__49609 = (idx + (1));
var G__49610 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__49607;
idx = G__49608;
start = G__49609;
out = G__49610;
...
var G__49611 = cljs.core.next(cvec_nl);
var G__49612 = (idx + (1));
var G__49613 = idx;
var G__49614 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__49611;
idx = G__49612;
start = G__49613;
out = G__49614;
...
var G__49615 = cljs.core.next(cvec_nl);
var G__49616 = (idx + (1));
var G__49617 = start;
var G__49618 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__49615;
idx = G__49616;
start = G__49617;
out = G__49618;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__49432_SHARP_,p2__49431_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__49431_SHARP_)){
return cljs.core.reduced(p1__49432_SHARP_);
} else {
return (p1__49432_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__49435,p__49436){
var vec__49437 = p__49435;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49437,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49437,(1),null);
var vec__49440 = p__49436;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49440,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49440,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__49451,cvec,focus_vec){
...
var map__49454 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49453__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49454__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49454__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49454__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49449_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__49449_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
