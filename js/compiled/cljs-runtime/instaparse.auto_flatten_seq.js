...
var instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_72139 = (function (self,obj){
...
return instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_72139(self,obj);
}
});

var instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_72140 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_72140(self);
}
});
...
var G__72143 = n__$1;
var G__72144 = y;
var G__72145 = cljs.core.imul(z,z);
n = G__72143;
y = G__72144;
z = G__72145;
continue;
...
var G__72146 = n__$1;
var G__72147 = cljs.core.imul(z,y);
var G__72148 = cljs.core.imul(z,z);
n = G__72146;
y = G__72147;
z = G__72148;
continue;
...
var G__72149 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(v__$1,(0));
var G__72150 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(index__$1,(0));
v__$1 = G__72149;
index__$1 = G__72150;
continue;
} else {
...
if((cljs.core.peek(index) < ((function (){var G__71958 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__71958) : instaparse.auto_flatten_seq.true_count.call(null,G__71958));
})() - (1)))){
...
var G__72155 = v;
var G__72156 = cljs.core.pop(index);
v = G__72155;
index = G__72156;
continue;
...
while(true){
if((!((coll__$1 == null)))){
var G__72179 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__72180 = cljs.core.next(coll__$1);
unmixed_hash = G__72179;
coll__$1 = G__72180;
continue;
} else {
return unmixed_hash;
...
var G__72184 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__72185 = cljs.core.next(v);
acc = G__72184;
v = G__72185;
continue;
} else {
var G__72186 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__72187 = cljs.core.next(v);
acc = G__72186;
v = G__72187;
continue;
}
...
var instaparse$auto_flatten_seq$GetVec$get_vec$dyn_72188 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$GetVec$get_vec$dyn_72188(self);
}
});
...
var self__ = this;
var self__ = this;
var G__72096 = (arguments.length - (1));
switch (G__72096) {
case (1):
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args72056){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args72056)));
}));
