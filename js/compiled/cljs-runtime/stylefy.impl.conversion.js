...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__88741_SHARP_){
return handle_mode(p1__88741_SHARP_,cljs.core.get.cljs$core$IFn$_invoke$arity$2(modes,p1__88741_SHARP_));
}),cljs.core.keys(modes));
} else {
if(cljs.core.vector_QMARK_(modes)){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__88742_SHARP_){
return handle_mode(cljs.core.first(p1__88742_SHARP_),cljs.core.second(p1__88742_SHARP_));
}),modes);
} else {
return null;
}
 ...
 */
stylefy.impl.conversion.convert_base_style_into_class = (function stylefy$impl$conversion$convert_base_style_into_class(p__88757,options){
var map__88758 = p__88757;
var map__88758__$1 = (((((!((map__88758 == null))))?(((((map__88758.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__88758.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__88758):map__88758);
var style = map__88758__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88758__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88758__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88758__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
 ...
 */
stylefy.impl.conversion.convert_media_queries = (function stylefy$impl$conversion$convert_media_queries(p__88772,options){
var map__88773 = p__88772;
var map__88773__$1 = (((((!((map__88773 == null))))?(((((map__88773.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__88773.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__88773):map__88773);
var style = map__88773__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88773__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88773__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88773__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
 ...
 */
stylefy.impl.conversion.convert_supports_rules = (function stylefy$impl$conversion$convert_supports_rules(p__88776,options){
var map__88777 = p__88776;
var map__88777__$1 = (((((!((map__88777 == null))))?(((((map__88777.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__88777.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__88777):map__88777);
var style = map__88777__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88777__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88777__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88777__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
 ...
 */
stylefy.impl.conversion.convert_manual_styles = (function stylefy$impl$conversion$convert_manual_styles(p__88780,options){
var map__88781 = p__88780;
var map__88781__$1 = (((((!((map__88781 == null))))?(((((map__88781.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__88781.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__88781):map__88781);
var style = map__88781__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88781__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88781__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88781__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
...
var manual_selector_and_css_props = clojure.walk.walk((function (p1__88779_SHARP_){
if(cljs.core.map_QMARK_(p1__88779_SHARP_)){
return stylefy.impl.utils.remove_special_keywords(p1__88779_SHARP_);
} else {
return p1__88779_SHARP_;
}
...
(stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$2 = (function (p__88797,options){
var map__88798 = p__88797;
var map__88798__$1 = (((((!((map__88798 == null))))?(((((map__88798.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__88798.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__88798):map__88798);
var style = map__88798__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88798__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88798__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
