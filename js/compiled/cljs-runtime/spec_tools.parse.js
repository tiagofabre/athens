...
var fexpr__82383 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__82383.cljs$core$IFn$_invoke$arity$1 ? fexpr__82383.cljs$core$IFn$_invoke$arity$1(type) : fexpr__82383.call(null,type));
});
...
var G__82492 = cljs.spec.alpha.form(cljs.spec.alpha.get_spec(x));
x = G__82492;
continue;
} else {
if((x instanceof cljs.core.Symbol)){
var G__82386 = spec_tools.impl.normalize_symbol(x);
var G__82387 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__82386,G__82387) : spec_tools.parse.parse_form.call(null,G__82386,G__82387));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__82389 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__82390 = x;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__82389,G__82390) : spec_tools.parse.parse_form.call(null,G__82389,G__82390));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__82494 = cljs.spec.alpha.form(x);
x = G__82494;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__82392 = spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x);
var G__82393 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__82392,G__82393) : spec_tools.parse.parse_form.call(null,G__82392,G__82393));
} else {
...
var G__82399 = parse_data;
var G__82399__$1 = (((G__82399 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__82399));
var G__82399__$2 = (((G__82399__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__82399__$1));
var G__82399__$3 = (((G__82399__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__82399__$2));
var G__82399__$4 = (((G__82399__$3 == null))?null:cljs.core.seq(G__82399__$3));
if((G__82399__$4 == null)){
return null;
} else {
return cljs.core.set(G__82399__$4);
}
}
});
...
var hierarchy__4623__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__82417 = cljs.core.get_global_hierarchy;
return (fexpr__82417.cljs$core$IFn$_invoke$arity$0 ? fexpr__82417.cljs$core$IFn$_invoke$arity$0() : fexpr__82417.call(null));
})());
...
var map__82457 = spec_tools.impl.parse_keys(form);
var map__82457__$1 = (((((!((map__82457 == null))))?(((((map__82457.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__82457.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__82457):map__82457);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82457__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82457__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82457__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82457__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82457__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__82462 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__82462__$1 = (cljs.core.truth_((function (){var or__4126__auto__ = req;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__82462,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__82462);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__82462__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__82462__$1;
}
}));
...
var map__82471 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__82471__$1 = (((((!((map__82471 == null))))?(((((map__82471.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__82471.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__82471):map__82471);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82471__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__82476 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
...
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82476__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__82479){
var vec__82480 = p__82479;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82480,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82480,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82480,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__82485){
var vec__82486 = p__82485;
var seq__82487 = cljs.core.seq(vec__82486);
var first__82488 = cljs.core.first(seq__82487);
var seq__82487__$1 = cljs.core.next(seq__82487);
var ___$1 = first__82488;
var values = seq__82487__$1;
