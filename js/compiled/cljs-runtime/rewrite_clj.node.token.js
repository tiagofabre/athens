...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k50011,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k50011,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__50034){
var vec__50035 = p__50034;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50035,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50035,(1),null);
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__50010){
var self__ = this;
var G__50010__$1 = this;
return (new cljs.core.RecordIter((0),G__50010__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"string-value","string-value",1109600561)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this50012,other50013){
var self__ = this;
var this50012__$1 = this;
return (((!((other50013 == null)))) && ((this50012__$1.constructor === other50013.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50012__$1.value,other50013.value)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50012__$1.string_value,other50013.string_value)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this50012__$1.__extmap,other50013.__extmap)));
}));
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__50010){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__50100 = cljs.core.keyword_identical_QMARK_;
var expr__50101 = k__4388__auto__;
if(cljs.core.truth_((pred__50100.cljs$core$IFn$_invoke$arity$2 ? pred__50100.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"value","value",305978217),expr__50101) : pred__50100.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__50101)))){
return (new rewrite_clj.node.token.TokenNode(G__50010,self__.string_value,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__50100.cljs$core$IFn$_invoke$arity$2 ? pred__50100.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"string-value","string-value",1109600561),expr__50101) : pred__50100.call(null,new cljs.core.Keyword(null,"string-value","string-value",1109600561),expr__50101)))){
return (new rewrite_clj.node.token.TokenNode(self__.value,G__50010,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.token.TokenNode(self__.value,self__.string_value,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__50010),null));
}
}
}));
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__50010){
var self__ = this;
var this__4379__auto____$1 = this;
return (new rewrite_clj.node.token.TokenNode(self__.value,self__.string_value,G__50010,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.token.map__GT_TokenNode = (function rewrite_clj$node$token$map__GT_TokenNode(G__50016){
var extmap__4419__auto__ = (function (){var G__50136 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__50016,new cljs.core.Keyword(null,"value","value",305978217),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string-value","string-value",1109600561)], 0));
if(cljs.core.record_QMARK_(G__50016)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__50136);
} else {
return G__50136;
}
})();
return (new rewrite_clj.node.token.TokenNode(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__50016),new cljs.core.Keyword(null,"string-value","string-value",1109600561).cljs$core$IFn$_invoke$arity$1(G__50016),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
