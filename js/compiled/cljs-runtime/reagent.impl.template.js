...
var G__51972 = o;
goog.object.set(G__51972,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__52045__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__52045 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__52046__i = 0, G__52046__a = new Array(arguments.length -  0);
while (G__52046__i < G__52046__a.length) {G__52046__a[G__52046__i] = arguments[G__52046__i + 0]; ++G__52046__i;}
  args = new cljs.core.IndexedSeq(G__52046__a,0,null);
} 
return G__52045__delegate.call(this,args);};
G__52045.cljs$lang$maxFixedArity = 0;
G__52045.cljs$lang$applyTo = (function (arglist__52047){
var args = cljs.core.seq(arglist__52047);
...
var G__51977 = o;
goog.object.set(G__51977,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__51978 = props;
var G__51978__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51978,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__51978);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51978__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__51978__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__51980 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51980,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__51980;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__51982){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51983__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__51987_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__51987_SHARP_);
}));
} else {
return null;
}
...
var vec__51993 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51993,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51993,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51993,(2),null);
...
var temp__5739__auto___52070 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___52070 == null)){
} else {
var key_52071 = temp__5739__auto___52070;
(jsprops.key = key_52071);
}
...
var temp__5739__auto___52072 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___52072 == null)){
} else {
var key_52073 = temp__5739__auto___52072;
(jsprops.key = key_52073);
}
...
var G__52005 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__52005) : reagent.impl.template.as_element.call(null,G__52005));
} else {
var temp__5739__auto___52074 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___52074 == null)){
} else {
var key_52077 = temp__5739__auto___52074;
(jsprops.key = key_52077);
}
...
var G__52008 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__52008)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__52008)){
return x;
} else {
...
var i__4737__auto___52079 = (0);
while(true){
if((i__4737__auto___52079 < len__4736__auto___52078)){
args__4742__auto__.push((arguments[i__4737__auto___52079]));

var G__52080 = (i__4737__auto___52079 + (1));
i__4737__auto___52079 = G__52080;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq52009){
var G__52010 = cljs.core.first(seq52009);
var seq52009__$1 = cljs.core.next(seq52009);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52010,seq52009__$1);
}));
...
break;
default:
var G__52096 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__52096;
continue;
...
var ctx = ({});
var vec__52038 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52038,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52038,(1),null);
...
var G__52043 = (cljs.core.count(argv) - first_child);
switch (G__52043) {
case (0):
