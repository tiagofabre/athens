...
day8.re_frame_10x.view.components.search_input = (function day8$re_frame_10x$view$components$search_input(p__49556){
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49558__$1,new cljs.core.Keyword(null,"title","title",636505583));
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49558__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var on_save = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49558__$1,new cljs.core.Keyword(null,"on-save","on-save",1618176266));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49558__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var on_stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49558__$1,new cljs.core.Keyword(null,"on-stop","on-stop",1520114515));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__49584){
var vec__49586 = p__49584;
var property = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49586,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49586,(1),null);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(property),value);
}),cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__49580_SHARP_){
return clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__49580_SHARP_,/:/);
...
var len__4736__auto___49672 = arguments.length;
var i__4737__auto___49674 = (0);
while(true){
if((i__4737__auto___49674 < len__4736__auto___49672)){
args__4742__auto__.push((arguments[i__4737__auto___49674]));

var G__49676 = (i__4737__auto___49674 + (1));
i__4737__auto___49674 = G__49676;
continue;
} else {
}
break;
...
var previous_config__49529__auto__ = devtools.prefs.get_prefs();
var prefs__49530__auto__ = day8.re_frame_10x.view.components.effective_cljs_devtools_prefs;
try{devtools.prefs.set_prefs_BANG_(prefs__49530__auto__);

return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(api_fn,args);
}finally {if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.prefs.get_prefs(),prefs__49530__auto__)){
} else {
throw (new Error(["Assert failed: ","someone modified devtools.prefs behind our back!","\n","(clojure.core/= (devtools.prefs/get-prefs) prefs__49530__auto__)"].join('')));
}

devtools.prefs.set_prefs_BANG_(previous_config__49529__auto__);
}}));

(day8.re_frame_10x.view.components.make_devtools_api_call.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(day8.re_frame_10x.view.components.make_devtools_api_call.cljs$lang$applyTo = (function (seq49593){
var G__49594 = cljs.core.first(seq49593);
var seq49593__$1 = cljs.core.next(seq49593);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49594,seq49593__$1);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___49685 = arguments.length;
var i__4737__auto___49686 = (0);
while(true){
if((i__4737__auto___49686 < len__4736__auto___49685)){
args__4742__auto__.push((arguments[i__4737__auto___49686]));

var G__49689 = (i__4737__auto___49686 + (1));
i__4737__auto___49686 = G__49689;
continue;
} else {
}
break;
...
/** @this {Function} */
(day8.re_frame_10x.view.components.cljs_devtools_header.cljs$lang$applyTo = (function (seq49601){
...
var args__4742__auto__ = [];
var len__4736__auto___49701 = arguments.length;
var i__4737__auto___49702 = (0);
while(true){
if((i__4737__auto___49702 < len__4736__auto___49701)){
args__4742__auto__.push((arguments[i__4737__auto___49702]));

var G__49703 = (i__4737__auto___49702 + (1));
i__4737__auto___49702 = G__49703;
continue;
} else {
}
break;
...
/** @this {Function} */
(day8.re_frame_10x.view.components.cljs_devtools_has_body.cljs$lang$applyTo = (function (seq49621){
var self__4724__auto__ = this;
...
var expanded_QMARK_ = (function (){var G__49625 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app-db","node-expanded?","app-db/node-expanded?",-1032853540),path], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__49625) : day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.subscribe.call(null,G__49625));
})();
...
var G__49626 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app-db","toggle-expansion","app-db/toggle-expansion",-1617765538),path__$1], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__49626) : day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.dispatch.call(null,G__49626));
...
})())?(function (){var G__49627 = day8.re_frame_10x.view.components.cljs_devtools_body.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([day8.re_frame_10x.view.components.get_object(jsonml__$1),day8.re_frame_10x.view.components.get_config(jsonml__$1)], 0));
var G__49628 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(path__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
return (day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2(G__49627,G__49628) : day8.re_frame_10x.view.components.jsonml__GT_hiccup.call(null,G__49627,G__49628));
})():(function (){var G__49629 = day8.re_frame_10x.view.components.cljs_devtools_header.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([day8.re_frame_10x.view.components.get_object(jsonml__$1),day8.re_frame_10x.view.components.get_config(jsonml__$1)], 0));
var G__49630 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(path__$1,new cljs.core.Keyword(null,"header","header",119441134));
return (day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2(G__49629,G__49630) : day8.re_frame_10x.view.components.jsonml__GT_hiccup.call(null,G__49629,G__49630));
})())], null);
});
});
/**
...
var vec__49632 = jsonml;
var seq__49633 = cljs.core.seq(vec__49632);
var first__49634 = cljs.core.first(seq__49633);
var seq__49633__$1 = cljs.core.next(seq__49633);
var tag_name = first__49634;
var first__49634__$1 = cljs.core.first(seq__49633__$1);
var seq__49633__$2 = cljs.core.next(seq__49633__$1);
var attributes = first__49634__$1;
var children = seq__49633__$2;
...
var G__49635 = child;
var G__49636 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(path,i);
return (day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame_10x.view.components.jsonml__GT_hiccup.cljs$core$IFn$_invoke$arity$2(G__49635,G__49636) : day8.re_frame_10x.view.components.jsonml__GT_hiccup.call(null,G__49635,G__49636));
})),children);
} else {
...
var expanded_QMARK_ = (function (){var G__49638 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app-db","node-expanded?","app-db/node-expanded?",-1032853540),path], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__49638) : day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.subscribe.call(null,G__49638));
})();
...
var G__49640 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("app-db","toggle-expansion","app-db/toggle-expansion",-1617765538),path], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__49640) : day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.dispatch.call(null,G__49640));
...
var G__49740 = (i__4737__auto___49735 + (1));
i__4737__auto___49735 = G__49740;
continue;
} else {
}
break;
...
(day8.re_frame_10x.view.components.simple_render.cljs$core$IFn$_invoke$arity$variadic = (function (data,path,p__49646){
var vec__49648 = p__49646;
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49648,(0),null);
var expanded_QMARK_ = day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.core.atom.cljs$core$IFn$_invoke$arity$1(true);
return (function (data__$1){
...
/** @this {Function} */
(day8.re_frame_10x.view.components.simple_render.cljs$lang$applyTo = (function (seq49642){
...
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49643,G__49644,seq49642__$2);
}));
