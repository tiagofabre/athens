...
var hierarchy__4623__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.json-schema","default","spec-tools.json-schema/default",-2093938695)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__85420 = cljs.core.get_global_hierarchy;
return (fexpr__85420.cljs$core$IFn$_invoke$arity$0 ? fexpr__85420.cljs$core$IFn$_invoke$arity$0() : fexpr__85420.call(null));
})());
...
var map__85461 = spec_tools.impl.parse_keys(spec_tools.impl.extract_form(spec));
var map__85461__$1 = (((((!((map__85461 == null))))?(((((map__85461.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__85461.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__85461):map__85461);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85461__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85461__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85461__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85461__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var map__85484 = spec_tools.parse.parse_spec(form);
...
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__85484__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__85489 = type;
var G__85489__$1 = (((G__85489 instanceof cljs.core.Keyword))?G__85489.fqn:null);
switch (G__85489__$1) {
case "map":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__85489__$1)].join('')));
...
var vec__85527 = spec_tools.impl.strip_fn_if_needed(spec);
var ___$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85527,(0),null);
var minimum = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85527,(1),null);
var maximum = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85527,(2),null);
var ___$4 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85527,(3),null);
...
var vec__85534 = spec_tools.impl.extract_form(spec);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85534,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__85534,(1),null);
...
var extra_info = (function (){var G__85537 = cljs.core.select_keys(data,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"description","description",-1428560544)], null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__85537,new cljs.core.Keyword(null,"title","title",636505583),spec_tools.impl.qualified_name(name));
} else {
return G__85537;
}
})();
