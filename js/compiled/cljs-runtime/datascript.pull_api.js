...
var map__71316 = rec;
var map__71316__$1 = (((((!((map__71316 == null))))?(((((map__71316.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__71316.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__71316):map__71316);
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71316__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71316__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__71338 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__71338__$1 = (((G__71338 == null))?null:cljs.core.persistent_BANG_(G__71338));
if((G__71338__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__71338__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__71345){
var vec__71347 = p__71345;
var seq__71348 = cljs.core.seq(vec__71347);
var first__71349 = cljs.core.first(seq__71348);
var seq__71348__$1 = cljs.core.next(seq__71348);
var frame = first__71349;
var frames = seq__71348__$1;
...
var results = (function (){var G__71357 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__71357,kvps);
} else {
return G__71357;
}
})();
...
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71369__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71369__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_71536 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_71536,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__71406){
var vec__71407 = p__71406;
var seq__71408 = cljs.core.seq(vec__71407);
var first__71409 = cljs.core.first(seq__71408);
var seq__71408__$1 = cljs.core.next(seq__71408);
var parent = first__71409;
var frames = seq__71408__$1;
...
var found = cljs.core.not_empty((function (){var G__71413 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__71413);
} else {
return G__71413;
}
})());
...
var as_value = (function (){var G__71423 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__71394_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__71394_SHARP_]);
}),G__71423);
} else {
return G__71423;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__71425 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__71425);
} else {
return G__71425;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__71426 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__71426,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__71426;
}
})());
...
var vec__71427 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71427,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71427,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__71430){
var vec__71431 = p__71430;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71431,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71431,(1),null);
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__71440){
var vec__71441 = p__71440;
var seq__71442 = cljs.core.seq(vec__71441);
var first__71443 = cljs.core.first(seq__71442);
var seq__71442__$1 = cljs.core.next(seq__71442);
var frame = first__71443;
var frames = seq__71442__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__71444){
var vec__71446 = p__71444;
...
var frame = first__71448;
var frames = seq__71447__$1;
...
var vec__71450 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71450,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71450,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71467__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71467__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__71470 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__71470,attr,eid);
} else {
return G__71470;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71476__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__71476__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__71478){
while(true){
var vec__71479 = p__71478;
...
var frame = first__71481;
var frames = seq__71480__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__71561 = db;
var G__71562 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__71561;
p__71478 = G__71562;
continue;
}
...
while(true){
var G__71482 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__71482__$1 = (((G__71482 instanceof cljs.core.Keyword))?G__71482.fqn:null);
switch (G__71482__$1) {
case "expand":
var G__71566 = db;
var G__71567 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__71566;
frames = G__71567;
continue;
...
case "expand-rev":
var G__71568 = db;
var G__71569 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__71568;
frames = G__71569;
continue;
...
case "pattern":
var G__71570 = db;
var G__71571 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__71570;
frames = G__71571;
continue;
...
case "recursion":
var G__71573 = db;
var G__71574 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__71573;
frames = G__71574;
continue;
...
var f = first__71488;
var remaining = seq__71487__$1;
var result = (function (){var G__71489 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__71489);
} else {
return G__71489;
}
})();
...
var G__71577 = db;
var G__71578 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__71490 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__71490,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__71490;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__71482__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__71491_SHARP_){
return datascript.db.entid_strict(db,p1__71491_SHARP_);
})),eids);
