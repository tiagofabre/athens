...
var G__78413 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__78413)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__78413)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__78413)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__78413)].join('')));
...
var G__78626 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__78627 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__78626;
v = G__78627;
continue;
} else {
var G__78634 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__78635 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__78634;
v = G__78635;
continue;
}
...
break;
case "\"":
var G__78636 = cljs.core.next(sq);
var G__78637 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__78636;
v = G__78637;
continue;
...
break;
default:
var G__78641 = cljs.core.next(sq);
var G__78642 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__78641;
v = G__78642;
continue;
...
while(true){
var G__78477 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__78477__$1 = (((G__78477 instanceof cljs.core.Keyword))?G__78477.fqn:null);
switch (G__78477__$1) {
case "rule":
var vec__78481 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78481,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78481,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__78486 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__78486) : instaparse.cfg.content.call(null,G__78486));
...
break;
case "paren":
var G__78662 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__78662;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__78490 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__78490) : instaparse.cfg.build_rule.call(null,G__78490));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__78492 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__78492) : instaparse.cfg.build_rule.call(null,G__78492));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__78493 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__78493) : instaparse.cfg.build_rule.call(null,G__78493));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__78495 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__78495) : instaparse.cfg.build_rule.call(null,G__78495));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__78496 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__78496) : instaparse.cfg.build_rule.call(null,G__78496));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__78497 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__78497) : instaparse.cfg.build_rule.call(null,G__78497));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__78477__$1)].join('')));
...
while(true){
var G__78498 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "neg":
case "rep":
var G__78680 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__78680;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__78498__$1)].join('')));
...
var valid_nts_78685 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__78507_78687 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__78508_78688 = null;
var count__78509_78689 = (0);
var i__78510_78690 = (0);
while(true){
if((i__78510_78690 < count__78509_78689)){
var nt_78691 = chunk__78508_78688.cljs$core$IIndexed$_nth$arity$2(null,i__78510_78690);
if(cljs.core.truth_((valid_nts_78685.cljs$core$IFn$_invoke$arity$1 ? valid_nts_78685.cljs$core$IFn$_invoke$arity$1(nt_78691) : valid_nts_78685.call(null,nt_78691)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_78691),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__78692 = seq__78507_78687;
var G__78693 = chunk__78508_78688;
var G__78694 = count__78509_78689;
var G__78695 = (i__78510_78690 + (1));
seq__78507_78687 = G__78692;
chunk__78508_78688 = G__78693;
count__78509_78689 = G__78694;
i__78510_78690 = G__78695;
continue;
} else {
var temp__5735__auto___78700 = cljs.core.seq(seq__78507_78687);
if(temp__5735__auto___78700){
var seq__78507_78701__$1 = temp__5735__auto___78700;
if(cljs.core.chunked_seq_QMARK_(seq__78507_78701__$1)){
var c__4556__auto___78702 = cljs.core.chunk_first(seq__78507_78701__$1);
var G__78703 = cljs.core.chunk_rest(seq__78507_78701__$1);
var G__78704 = c__4556__auto___78702;
var G__78705 = cljs.core.count(c__4556__auto___78702);
var G__78706 = (0);
seq__78507_78687 = G__78703;
chunk__78508_78688 = G__78704;
count__78509_78689 = G__78705;
i__78510_78690 = G__78706;
continue;
} else {
var nt_78710 = cljs.core.first(seq__78507_78701__$1);
if(cljs.core.truth_((valid_nts_78685.cljs$core$IFn$_invoke$arity$1 ? valid_nts_78685.cljs$core$IFn$_invoke$arity$1(nt_78710) : valid_nts_78685.call(null,nt_78710)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_78710),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__78711 = cljs.core.next(seq__78507_78701__$1);
var G__78712 = null;
var G__78713 = (0);
var G__78714 = (0);
seq__78507_78687 = G__78711;
chunk__78508_78688 = G__78712;
count__78509_78689 = G__78713;
i__78510_78690 = G__78714;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__78532_78719 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__78533_78720 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__78534_78721 = true;
var _STAR_print_fn_STAR__temp_val__78535_78722 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__78534_78721);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__78535_78722);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__78533_78720);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__78532_78719);
}
...
var len__4736__auto___78741 = arguments.length;
var i__4737__auto___78742 = (0);
while(true){
if((i__4737__auto___78742 < len__4736__auto___78741)){
args__4742__auto__.push((arguments[i__4737__auto___78742]));

var G__78743 = (i__4737__auto___78742 + (1));
i__4737__auto___78742 = G__78743;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__78556){
var map__78558 = p__78556;
...
var opts = map__78558__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__78561 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__78562 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__78562);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4667__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__78568_78747 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__78569_78748 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__78570_78749 = true;
var _STAR_print_fn_STAR__temp_val__78571_78750 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__78570_78749);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__78571_78750);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__78569_78748);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__78568_78747);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__78561);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq78550){
var G__78551 = cljs.core.first(seq78550);
var seq78550__$1 = cljs.core.next(seq78550);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__78551,seq78550__$1);
}));
