...
}catch (e38706){if((e38706 instanceof Error)){
var _e = e38706;
return null;
} else {
throw e38706;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__38718),athens$views$daily_notes$daily_notes_panel_$_iter__38715(cljs.core.chunk_rest(s__38716__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38718),null);
}
} else {
var map__38724 = cljs.core.first(s__38716__$2);
...
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38724__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.views.daily_notes.daily_notes_page_style),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.node_page.node_page_component,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null)], null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)),athens$views$daily_notes$daily_notes_panel_$_iter__38715(cljs.core.rest(s__38716__$2)));
}
} else {
return null;
}
