...
var len__4736__auto___67293 = arguments.length;
var i__4737__auto___67294 = (0);
while(true){
if((i__4737__auto___67294 < len__4736__auto___67293)){
args__4742__auto__.push((arguments[i__4737__auto___67294]));

var G__67295 = (i__4737__auto___67294 + (1));
i__4737__auto___67294 = G__67295;
continue;
} else {
}
break;
...
/** @this {Function} */
(posh.stateful.add_q.cljs$lang$applyTo = (function (seq67246){
var G__67247 = cljs.core.first(seq67246);
var seq67246__$1 = cljs.core.next(seq67246);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__67247,seq67246__$1);
}));

posh.stateful.add_filter_tx = (function posh$stateful$add_filter_tx(poshdb,tx_patterns){
var posh_atom = posh.stateful.get_posh_atom(poshdb);
return cljs.core.with_meta(new cljs.core.Keyword(null,"return","return",-1891502105).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(posh_atom,(function (p1__67252_SHARP_){
return posh.core.add_filter_tx(p1__67252_SHARP_,poshdb,tx_patterns);
...
var posh_atom = posh.stateful.get_posh_atom(poshdb);
return cljs.core.with_meta(new cljs.core.Keyword(null,"return","return",-1891502105).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(posh_atom,(function (p1__67253_SHARP_){
return posh.core.add_filter_pull(p1__67253_SHARP_,poshdb,pull_pattern,eid);
}))),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"posh","posh",-1205664462),posh_atom], null));
});
posh.stateful.add_filter_q = (function posh$stateful$add_filter_q(var_args){
var args__4742__auto__ = [];
var len__4736__auto___67306 = arguments.length;
var i__4737__auto___67307 = (0);
while(true){
if((i__4737__auto___67307 < len__4736__auto___67306)){
args__4742__auto__.push((arguments[i__4737__auto___67307]));

var G__67309 = (i__4737__auto___67307 + (1));
i__4737__auto___67307 = G__67309;
continue;
} else {
}
break;
...
var posh_atom = cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2(posh.stateful.get_posh_atom,args)));
return cljs.core.with_meta(new cljs.core.Keyword(null,"return","return",-1891502105).cljs$core$IFn$_invoke$arity$1(cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(posh_atom,(function (p1__67255_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(posh.core.add_filter_q,p1__67255_SHARP_,query,args);
}))),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"posh","posh",-1205664462),posh_atom], null));
}));
...
/** @this {Function} */
(posh.stateful.add_filter_q.cljs$lang$applyTo = (function (seq67256){
var G__67257 = cljs.core.first(seq67256);
var seq67256__$1 = cljs.core.next(seq67256);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__67257,seq67256__$1);
}));
