...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__82285_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__82285_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__82284_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__82284_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__82286_SHARP_){
return (((p1__82286_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__82286_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__82300,mapping){
var map__82301 = p__82300;
var map__82301__$1 = (((((!((map__82301 == null))))?(((((map__82301.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__82301.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__82301):map__82301);
var state = map__82301__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82301__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82301__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82301__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__82295_SHARP_){
if((p1__82295_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__82295_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__82403 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__82410 = clojure.zip.next(loc);
loc = G__82410;
continue;
}
}
...
var len__4736__auto___82430 = arguments.length;
var i__4737__auto___82431 = (0);
while(true){
if((i__4737__auto___82431 < len__4736__auto___82430)){
args__4742__auto__.push((arguments[i__4737__auto___82431]));

var G__82432 = (i__4737__auto___82431 + (1));
i__4737__auto___82431 = G__82432;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__82339){
var vec__82340 = p__82339;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82340,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq82336){
var G__82337 = cljs.core.first(seq82336);
var seq82336__$1 = cljs.core.next(seq82336);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__82337,seq82336__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__82343_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__82343_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__82349_82433 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__82350_82434 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__82351_82435 = true;
var _STAR_print_fn_STAR__temp_val__82352_82436 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__82351_82435);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__82352_82436);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__82350_82434);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__82349_82433);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__82344_SHARP_){
return debux.common.util.prepend_bars(p1__82344_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__82437 = cljs.core.next(opts__$1);
var G__82438 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__82437;
acc = G__82438;
continue;
} else {
if(typeof f === 'string'){
var G__82439 = cljs.core.next(opts__$1);
var G__82440 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__82439;
acc = G__82440;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__82441 = cljs.core.nnext(opts__$1);
var G__82442 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__82441;
acc = G__82442;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__82443 = cljs.core.next(opts__$1);
var G__82444 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__82443;
acc = G__82444;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__82360 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__82360.cljs$core$IFn$_invoke$arity$1 ? fexpr__82360.cljs$core$IFn$_invoke$arity$1(f) : fexpr__82360.call(null,f));
})())){
var G__82445 = cljs.core.next(opts__$1);
var G__82446 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__82445;
acc = G__82446;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__82361 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__82361.cljs$core$IFn$_invoke$arity$1 ? fexpr__82361.cljs$core$IFn$_invoke$arity$1(f) : fexpr__82361.call(null,f));
})())){
var G__82447 = cljs.core.nnext(opts__$1);
var G__82448 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__82447;
acc = G__82448;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__82449 = cljs.core.next(opts__$1);
var G__82450 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__82449;
acc = G__82450;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__82362){
var vec__82363 = p__82362;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82363,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82363,(1),null);
...
var G__82368 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__82367 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__82367.cljs$core$IFn$_invoke$arity$1 ? fexpr__82367.cljs$core$IFn$_invoke$arity$1(G__82368) : fexpr__82367.call(null,G__82368));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__82371 = quoted_form;
var G__82372 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__82371,G__82372) : debux.common.util.remove_d.call(null,G__82371,G__82372));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__82373 = quoted_form;
var G__82374 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__82373,G__82374) : debux.common.util.remove_d.call(null,G__82373,G__82374));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__82451__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__82377 = quoted_form;
var G__82378 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__82377,G__82378) : debux.common.util.remove_d.call(null,G__82377,G__82378));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));

return result;
};
var G__82451 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__82452__i = 0, G__82452__a = new Array(arguments.length -  0);
while (G__82452__i < G__82452__a.length) {G__82452__a[G__82452__i] = arguments[G__82452__i + 0]; ++G__82452__i;}
  arg = new cljs.core.IndexedSeq(G__82452__a,0,null);
} 
return G__82451__delegate.call(this,arg);};
G__82451.cljs$lang$maxFixedArity = 0;
G__82451.cljs$lang$applyTo = (function (arglist__82453){
var arg = cljs.core.seq(arglist__82453);
return G__82451__delegate(arg);
});
...
var G__82454 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__82454;
continue;
} else {
...
var G__82455 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__82455;
continue;
} else {
var G__82456 = clojure.zip.next(loc);
loc = G__82456;
continue;
