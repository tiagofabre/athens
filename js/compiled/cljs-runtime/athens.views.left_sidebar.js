...
athens.views.left_sidebar.shortcut_component = (function athens$views$left_sidebar$shortcut_component(p__91308){
var vec__91309 = p__91308;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91309,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91309,(1),null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91309,(2),null);
var drag = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(null);
return (function (p__91312){
var vec__91313 = p__91312;
var order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91313,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91313,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__91313,(2),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([athens.views.left_sidebar.shortcut_style,(function (){var G__91317 = cljs.core.deref(drag);
var G__91317__$1 = (((G__91317 instanceof cljs.core.Keyword))?G__91317.fqn:null);
switch (G__91317__$1) {
case "above":
...
var source_order_91360 = parseInt(e.dataTransfer.getData("text/plain"));
cljs.core.prn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([source_order_91360,order], 0));

if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(source_order_91360,order)){
} else {
if(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(source_order_91360,(order - (1)))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(drag),new cljs.core.Keyword(null,"above","above",-1286866470))))){
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(drag),new cljs.core.Keyword(null,"below","below",-926774883))){
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("left-sidebar","drop-below","left-sidebar/drop-below",1291292866),source_order_91360,order], null));
} else {
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("left-sidebar","drop-above","left-sidebar/drop-above",75584917),source_order_91360,order], null));
