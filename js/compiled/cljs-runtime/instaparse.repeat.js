...
var vec__78433 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78433,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78433,(1),null);
...
var vec__78436 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78436,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78436,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__78446 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78446,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78446,(1),null);
...
var G__78682 = cljs.core.next(parses__$1);
parses__$1 = G__78682;
continue;
}
...
var G__78471 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__78473 = G__78471;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78473,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78473,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78473,(2),null);
var selection = vec__78473;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__78471__$1 = G__78471;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__78487 = G__78471__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78487,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78487,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78487,(2),null);
var selection__$1 = vec__78487;
...
var G__78730 = cljs.core.long$(end__$1);
var G__78731 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__78732 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__78730;
parses__$1 = G__78731;
G__78471__$1 = G__78732;
continue;
...
var G__78516 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__78518 = G__78516;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78518,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78518,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78518,(2),null);
var selection = vec__78518;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__78516__$1 = G__78516;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__78526 = G__78516__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78526,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78526,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78526,(2),null);
var selection__$1 = vec__78526;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__78752 = cljs.core.long$(end__$1);
var G__78753 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__78754 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__78752;
parses__$1 = G__78753;
G__78516__$1 = G__78754;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__78541 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__78543 = G__78541;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78543,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78543,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78543,(2),null);
var selection = vec__78543;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__78541__$1 = G__78541;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__78553 = G__78541__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78553,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78553,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__78553,(2),null);
var selection__$1 = vec__78553;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__78772 = cljs.core.long$(end__$1);
var G__78773 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__78774 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__78772;
parses__$1 = G__78773;
G__78541__$1 = G__78774;
continue;
...
if(cljs.core.truth_((function (){var fexpr__78580 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__78580.cljs$core$IFn$_invoke$arity$1 ? fexpr__78580.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__78580.call(null,output_format));
})())){
} else {
...
var G__78604 = output_format;
var G__78604__$1 = (((G__78604 instanceof cljs.core.Keyword))?G__78604.fqn:null);
switch (G__78604__$1) {
case "enlive":
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4115__auto__ = (function (){var G__78623 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__78622 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__78622.cljs$core$IFn$_invoke$arity$1 ? fexpr__78622.cljs$core$IFn$_invoke$arity$1(G__78623) : fexpr__78622.call(null,G__78623));
})();
