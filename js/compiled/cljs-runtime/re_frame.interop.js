...
return [(function (){var pred__52329 = cljs.core.instance_QMARK_;
var expr__52330 = reactive_val;
if(cljs.core.truth_((pred__52329.cljs$core$IFn$_invoke$arity$2 ? pred__52329.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__52330) : pred__52329.call(null,reagent.ratom.RAtom,expr__52330)))){
return "ra";
} else {
if(cljs.core.truth_((pred__52329.cljs$core$IFn$_invoke$arity$2 ? pred__52329.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__52330) : pred__52329.call(null,reagent.ratom.RCursor,expr__52330)))){
return "rc";
} else {
if(cljs.core.truth_((pred__52329.cljs$core$IFn$_invoke$arity$2 ? pred__52329.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__52330) : pred__52329.call(null,reagent.ratom.Reaction,expr__52330)))){
return "rx";
} else {
if(cljs.core.truth_((pred__52329.cljs$core$IFn$_invoke$arity$2 ? pred__52329.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__52330) : pred__52329.call(null,reagent.ratom.Track,expr__52330)))){
return "tr";
} else {
return "other";
}
