...
if(cljs.core.truth_((function (){var fexpr__80351 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__80351.cljs$core$IFn$_invoke$arity$1 ? fexpr__80351.cljs$core$IFn$_invoke$arity$1(type) : fexpr__80351.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__80353 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__80353.cljs$core$IFn$_invoke$arity$1 ? fexpr__80353.cljs$core$IFn$_invoke$arity$1(type) : fexpr__80353.call(null,type));
})())){
} else {
...
var G__80355 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__80355)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__80355)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__80355)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__80355)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__80355)].join('')));
...
var len__4736__auto___80524 = arguments.length;
var i__4737__auto___80525 = (0);
while(true){
if((i__4737__auto___80525 < len__4736__auto___80524)){
args__4742__auto__.push((arguments[i__4737__auto___80525]));

var G__80532 = (i__4737__auto___80525 + (1));
i__4737__auto___80525 = G__80532;
continue;
} else {
}
break;
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__80366){
var map__80367 = p__80366;
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__80375 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__80375) : instaparse.reduction.node_builders.call(null,G__80375));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq80359){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__80360,G__80361,seq80359__$2);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___80549 = arguments.length;
var i__4737__auto___80550 = (0);
while(true){
if((i__4737__auto___80550 < len__4736__auto___80549)){
args__4742__auto__.push((arguments[i__4737__auto___80550]));

var G__80551 = (i__4737__auto___80550 + (1));
i__4737__auto___80550 = G__80551;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__80386){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__80390 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__80390) : instaparse.reduction.node_builders.call(null,G__80390));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq80379){
var G__80380 = cljs.core.first(seq80379);
var seq80379__$1 = cljs.core.next(seq80379);
var G__80381 = cljs.core.first(seq80379__$1);
var seq80379__$2 = cljs.core.next(seq80379__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__80380,G__80381,seq80379__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k80394,else__4383__auto__){
var self__ = this;
var this__4382__auto____$1 = this;
var G__80403 = k80394;
var G__80403__$1 = (((G__80403 instanceof cljs.core.Keyword))?G__80403.fqn:null);
switch (G__80403__$1) {
case "grammar":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k80394,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__80404){
var vec__80407 = p__80404;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80407,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__80407,(1),null);
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this80395,other80396){
var self__ = this;
var this80395__$1 = this;
return (((!((other80396 == null)))) && ((this80395__$1.constructor === other80396.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this80395__$1.grammar,other80396.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this80395__$1.start_production,other80396.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this80395__$1.output_format,other80396.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this80395__$1.__extmap,other80396.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__80393){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__80423 = cljs.core.keyword_identical_QMARK_;
var expr__80424 = k__4388__auto__;
if(cljs.core.truth_((pred__80423.cljs$core$IFn$_invoke$arity$2 ? pred__80423.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__80424) : pred__80423.call(null,new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__80424)))){
return (new instaparse.core.Parser(G__80393,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__80423.cljs$core$IFn$_invoke$arity$2 ? pred__80423.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__80424) : pred__80423.call(null,new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__80424)))){
return (new instaparse.core.Parser(self__.grammar,G__80393,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__80423.cljs$core$IFn$_invoke$arity$2 ? pred__80423.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__80424) : pred__80423.call(null,new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__80424)))){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__80393,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__80393),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__80393){
var self__ = this;
var this__4379__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__80393,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__80432 = (arguments.length - (1));
switch (G__80432) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args80401){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args80401)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__80399){
var extmap__4419__auto__ = (function (){var G__80459 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__80399,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__80399)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__80459);
} else {
return G__80459;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__80399),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__80399),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__80399),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var args__4742__auto__ = [];
var len__4736__auto___80670 = arguments.length;
var i__4737__auto___80671 = (0);
while(true){
if((i__4737__auto___80671 < len__4736__auto___80670)){
args__4742__auto__.push((arguments[i__4737__auto___80671]));

var G__80672 = (i__4737__auto___80671 + (1));
i__4737__auto___80671 = G__80672;
continue;
} else {
}
break;
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__80471){
var map__80473 = p__80471;
var map__80473__$1 = (((((!((map__80473 == null))))?(((((map__80473.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__80473.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__80473):map__80473);
var options = map__80473__$1;
...
var _STAR_case_insensitive_literals_STAR__orig_val__80489 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__80490 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__80490);

try{var G__80492 = input_format;
var G__80492__$1 = (((G__80492 instanceof cljs.core.Keyword))?G__80492.fqn:null);
switch (G__80492__$1) {
case "abnf":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__80492__$1)].join('')));

}
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__80489);
}});
...
var map__80500 = temp__5733__auto__;
var map__80500__$1 = (((((!((map__80500 == null))))?(((((map__80500.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__80500.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__80500):map__80500);
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80500__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__80500__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq80465){
var G__80466 = cljs.core.first(seq80465);
var seq80465__$1 = cljs.core.next(seq80465);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__80466,seq80465__$1);
}));
