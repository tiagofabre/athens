...
var G__51490 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__51490;
continue;
} else {
var G__51491 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__51491;
continue;
}
} else {
var G__51492 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__51492;
continue;
}
}
...
var G__51473 = zloc;
var G__51474 = (function (){var G__51475 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__51476 = zloc;
var G__51476__$1 = (((G__51476 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__51476) : rewrite_clj.zip.node.call(null,G__51476)));
if((G__51476__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__51476__$1) : zprint.zutil.edn_STAR_.call(null,G__51476__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__51475) : rewrite_clj.zip.root.call(null,G__51475));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__51473,G__51474) : rewrite_clj.zip.replace.call(null,G__51473,G__51474));
});
/**
...
var G__51499 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__51499;
continue;
}
break;
...
var G__51504 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__51505 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__51504;
out = G__51505;
continue;
} else {
...
var G__51510 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__51511 = cljs.core.next(new_loc);
var G__51512 = replaced_loc;
nloc = G__51510;
new_loc = G__51511;
last_loc = G__51512;
continue;
...
return zprint.rewrite.sort_val((function (){var G__51486 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__51486) : rewrite_clj.zip.down.call(null,G__51486));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__51487_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__51487_SHARP_) : rewrite_clj.zip.tag.call(null,p1__51487_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__51487_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__51487_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
