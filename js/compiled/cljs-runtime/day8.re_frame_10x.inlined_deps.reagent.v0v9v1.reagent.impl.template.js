...
return (function() { 
var G__47389__delegate = function (args){
...
while (G__47390__i < G__47390__a.length) {G__47390__a[G__47390__i] = arguments[G__47390__i + 0]; ++G__47390__i;}
  args = new cljs.core.IndexedSeq(G__47390__a,0,null);
} 
return G__47389__delegate.call(this,args);};
G__47389.cljs$lang$maxFixedArity = 0;
G__47389.cljs$lang$applyTo = (function (arglist__47391){
var args = cljs.core.seq(arglist__47391);
return G__47389__delegate(args);
});
...
var G__47270 = o;
goog.object.set(G__47270,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.cached_custom_prop_name(k),day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__47405__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__47406__i < G__47406__a.length) {G__47406__a[G__47406__i] = arguments[G__47406__i + 0]; ++G__47406__i;}
  args = new cljs.core.IndexedSeq(G__47406__a,0,null);
} 
return G__47405__delegate.call(this,args);};
G__47405.cljs$lang$maxFixedArity = 0;
G__47405.cljs$lang$applyTo = (function (arglist__47407){
var args = cljs.core.seq(arglist__47407);
return G__47405__delegate(args);
});
...
var G__47278 = props;
var G__47278__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47278,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__47278);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47278__$1,new cljs.core.Keyword(null,"class","class",-2030961996),day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__47278__$1;
}
});
...
var props__$1 = day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.set_id_class((function (){var G__47283 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__47283,new cljs.core.Keyword(null,"class","class",-2030961996),day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__47283;
}
})(),id_class);
...
day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.input_node_set_value = (function day8$re_frame_10x$inlined_deps$reagent$v0v9v1$reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__47286){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47287__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__47291_SHARP_){
return day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.input_handle_change(this$,on_change,p1__47291_SHARP_);
}));
} else {
return null;
}
...
var vec__47294 = cljs.core.next(cljs.core.re_matches(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47294,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47294,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47294,(2),null);
...
var temp__5739__auto___47451 = day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___47451 == null)){
} else {
var key_47452 = temp__5739__auto___47451;
(jsprops.key = key_47452);
}
...
var temp__5739__auto___47454 = day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___47454 == null)){
} else {
var key_47455 = temp__5739__auto___47454;
(jsprops.key = key_47455);
}
...
var G__47308 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__47308) : day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.as_element.call(null,G__47308));
} else {
var temp__5739__auto___47470 = day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___47470 == null)){
} else {
var key_47472 = temp__5739__auto___47470;
(jsprops.key = key_47472);
}
...
var G__47321 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__47321)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__47321)){
return x;
} else {
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq47325){
var G__47327 = cljs.core.first(seq47325);
var seq47325__$1 = cljs.core.next(seq47325);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__47327,seq47325__$1);
}));
...
break;
default:
var G__47487 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__47487;
continue;
...
var ctx = ({});
var vec__47366 = day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.check_derefs((function (){
return day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47366,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47366,(1),null);
...
var G__47372 = (cljs.core.count(argv) - first_child);
switch (G__47372) {
case (0):
