...
var vec__82287 = cljs.core.rest(expr);
var seq__82288 = cljs.core.seq(vec__82287);
var first__82289 = cljs.core.first(seq__82288);
var seq__82288__$1 = cljs.core.next(seq__82288);
var vec__82290 = first__82289;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82290,(0),null);
var form = seq__82288__$1;
...
var G__82293 = x;
var G__82293__$1 = (((G__82293 == null))?null:spec_tools.impl.polish(G__82293));
var G__82293__$2 = (((G__82293__$1 == null))?null:cljs.core.name(G__82293__$1));
if((G__82293__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__82293__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__82294 = x;
var G__82294__$1 = (((G__82294 == null))?null:cljs.core.name(G__82294));
if((G__82294__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__82294__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__82297){
var map__82298 = p__82297;
var map__82298__$1 = (((((!((map__82298 == null))))?(((((map__82298.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__82298.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__82298):map__82298);
var data = map__82298__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82298__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82298__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82298__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82298__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__82303){
var map__82304 = p__82303;
var map__82304__$1 = (((((!((map__82304 == null))))?(((((map__82304.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__82304.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__82304):map__82304);
var data = map__82304__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82304__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82304__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__82310 = data;
var G__82310__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__82310,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__82310);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__82310__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__82310__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__82315 = form;
var G__82315__$1 = (((G__82315 == null))?null:cljs.core.rest(G__82315));
if((G__82315__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__82315__$1);
}
})();
var G__82316 = m;
var G__82316__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__82316,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__82312_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__82312_SHARP_)));
})):G__82316);
var G__82316__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__82316__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__82313_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__82313_SHARP_)));
})):G__82316__$1);
var G__82316__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__82316__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__82314_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__82314_SHARP_));
})):G__82316__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__82316__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__82317 = (function (){var G__82318 = form;
var G__82318__$1 = (((G__82318 == null))?null:cljs.core.rest(G__82318));
if((G__82318__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__82318__$1);
}
})();
var map__82317__$1 = (((((!((map__82317 == null))))?(((((map__82317.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__82317.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__82317):map__82317);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82317__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82317__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82317__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82317__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__82329 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__82329) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__82334 = form;
var G__82334__$1 = (((G__82334 == null))?null:cljs.core.seq(G__82334));
var G__82334__$2 = (((G__82334__$1 == null))?null:cljs.core.first(G__82334__$1));
if((G__82334__$2 == null)){
return null;
} else {
var fexpr__82335 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__82335.cljs$core$IFn$_invoke$arity$1 ? fexpr__82335.cljs$core$IFn$_invoke$arity$1(G__82334__$2) : fexpr__82335.call(null,G__82334__$2));
}
})():null));
});
/**
...
var len__4736__auto___82416 = arguments.length;
var i__4737__auto___82418 = (0);
while(true){
if((i__4737__auto___82418 < len__4736__auto___82416)){
args__4742__auto__.push((arguments[i__4737__auto___82418]));

var G__82419 = (i__4737__auto___82418 + (1));
i__4737__auto___82418 = G__82419;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq82338){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq82338));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__82345){
var vec__82346 = p__82345;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82346,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__82346,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__82357){
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82358__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82358__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82358__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__82358__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__82355_SHARP_){
return cljs.core.map_QMARK_(p1__82355_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__82356_SHARP_){
return cljs.core.contains_QMARK_(p1__82356_SHARP_,x);
});
}),req_keys));
