 ...
 */
day8.re_frame.async_flow_fx.dissoc_in = (function day8$re_frame$async_flow_fx$dissoc_in(m,p__88629){
var vec__88630 = p__88629;
var seq__88631 = cljs.core.seq(vec__88630);
var first__88632 = cljs.core.first(seq__88631);
var seq__88631__$1 = cljs.core.next(seq__88631);
var k = first__88632;
var ks = seq__88631__$1;
var keys = vec__88630;
if(ks){
...
var G__88642 = new cljs.core.Keyword(null,"events","events",1792552201).cljs$core$IFn$_invoke$arity$1(task);
var G__88643 = now_seen_events;
var fexpr__88641 = new cljs.core.Keyword(null,"when","when",-576417306).cljs$core$IFn$_invoke$arity$1(task);
return (fexpr__88641.cljs$core$IFn$_invoke$arity$2 ? fexpr__88641.cljs$core$IFn$_invoke$arity$2(G__88642,G__88643) : fexpr__88641.call(null,G__88642,G__88643));
...
return cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (index,p__88649){
var map__88650 = p__88649;
var map__88650__$1 = (((((!((map__88650 == null))))?(((((map__88650.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__88650.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__88650):map__88650);
var rule = map__88650__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88650__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var when = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88650__$1,new cljs.core.Keyword(null,"when","when",-576417306));
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88650__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88650__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88650__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88650__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var halt_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88650__$1,new cljs.core.Keyword(null,"halt?","halt?",-1110658247));
...
var G__88655 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__4126__auto__ = id;
...
var G__88655__$1 = (cljs.core.truth_(dispatch_fn)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__88655,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614),dispatch_fn):G__88655);
if(cljs.core.not(dispatch_fn)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__88655__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236),(cljs.core.truth_(dispatch_n)?dispatch_n:(cljs.core.truth_(dispatch)?(new cljs.core.List(null,dispatch,null,(1),null)):cljs.core.List.EMPTY
)));
} else {
return G__88655__$1;
}
...
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88658__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88658__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
 ...
 */
day8.re_frame.async_flow_fx.make_flow_event_handler = (function day8$re_frame$async_flow_fx$make_flow_event_handler(p__88660){
var map__88661 = p__88660;
var map__88661__$1 = (((((!((map__88661 == null))))?(((((map__88661.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__88661.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__88661):map__88661);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88661__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var db_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88661__$1,new cljs.core.Keyword(null,"db-path","db-path",-68094099));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88661__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var first_dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88661__$1,new cljs.core.Keyword(null,"first-dispatch","first-dispatch",128561923));
...
return (function day8$re_frame$async_flow_fx$make_flow_event_handler_$_async_flow_event_handler(p__88663,p__88664){
var map__88665 = p__88663;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88665__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__88666 = p__88664;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88666,(0),null);
var event_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88666,(1),null);
var event_v = vec__88666;
var pred__88670 = cljs.core._EQ_;
var expr__88671 = event_type;
if(cljs.core.truth_((pred__88670.cljs$core$IFn$_invoke$arity$2 ? pred__88670.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"setup","setup",1987730512),expr__88671) : pred__88670.call(null,new cljs.core.Keyword(null,"setup","setup",1987730512),expr__88671)))){
...
var vec__88673 = event_v;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88673,(0),null);
var forwarded_event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88673,(1),null);
var map__88676 = get_state(db);
var map__88676__$1 = (((((!((map__88676 == null))))?(((((map__88676.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__88676.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__88676):map__88676);
var seen_events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88676__$1,new cljs.core.Keyword(null,"seen-events","seen-events",1607648392));
var rules_fired = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__88676__$1,new cljs.core.Keyword(null,"rules-fired","rules-fired",-1669838140));
...
var vec__88678 = day8.re_frame.async_flow_fx.ensure_has_id(flow);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88678,(0),null);
var flow_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__88678,(1),null);
